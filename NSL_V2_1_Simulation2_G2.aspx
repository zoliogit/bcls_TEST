<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_1_Simulation2_G2.aspx.cs" Inherits="NSL_V2_1_Simulation2_G2" %>
           ...
           <tr bgcolor="#98272D">
            ...
            <tr>
                ...
                **Accord "0" mark if student did not perform any steps.<br /> TSO:<br />
                ...
                RR-28b/min, HR-150b/min, BP-86/50mmHg, SpO2-89%, Temp-36.9 deg Celcius
                </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td>Lecturer:<br />
                    BP is low and PR & RR is increased: indicates significant blood loss. SpO2 is low as oxygen carrying capacity with blood loss. Patient is going into hypovolemic shock.
             ...
             <%-- ----------------------------------------------------------------------------- --%> 
              <tr>
                ...
                <td>Lecturer:<br/> BP is low and PR & RR is increased: indicates significant blood loss. SpO2 is low as oxygen carrying capacity with blood loss. Patient is going into hypovolemic shock.
            ...
            <tr>
                <td rowspan="10">7</td>
                <td align="left" rowspan="10">Recognise signs and symptoms (s/s) of hypovolemic shock timely
                </td>
                ...
                <td rowspan="10">Lecturer:<br />
                    Inform the s/s of hypovolemia to students.<br />

                    TSO:<br />
                    Set manikin:
                    Breath sounds- clear, heart sound- normal. Slow to respond and confuse.

                </td>
            </tr>
            <tr>
                <td align="left">Anxiety or agitation
               </td>
            </tr>
            <tr>
                <td align="left">Cool, clammy skin
                </td>
            </tr>
            <tr>
                <td align="left">Confusion
                </td>
            </tr>
            <tr>
                <td align="left">Decreased or no urine output
                </td>
            </tr>
            <tr>
                <td align="left">Pale skin color (pallor)
                </td>
            </tr>
            <tr>
                <td align="left">Rapid breathing/Tachypnea
                </td>
            </tr>
            <tr>
                <td align="left">Sweating, moist skin
                </td>
            </tr>
            <tr>
                <td align="left">Unconsciousness
                </td>
            </tr>
            <tr>
                <td align="left">Perform CLC.
                </td>
            </tr>
            <%-- ----------------------------------------------------------------------------- --%> 
             <tr>
                <td>8</td>
                <td align="left">Manage the signs of shock
                </td>
                <td align="left">Increase the infusion rate of IV Hartmann's.
                </td>
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList8" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
             ...
             <tr>
                <td>9</td>
                <td align="left">Continue to monitor patient's vital signs. 
                </td>
                <td align="left">Check vital signs.
                </td>
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList9" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
             ...
             <tr>
                <td>10</td>
                <td align="left">Check doctor's order from progress notes & IMR.
                </td>
                <td align="left">The type of blood product and number of unit(s) ordered.
                </td>
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList10" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
             ...
             <tr>
                <td>11</td>
                <td align="left">Assess for past medical history.
                </td>
                <td align="left">e.g. cardiac, renal or pulmonary condition or any s/s of fluid overload.
                </td>
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList11" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
            ...
            <%-- ----------------------------------------------------------------------------- --%> 
             <tr>
                <td>12</td>
                <td align="left">Check consent.
                </td>
                <td align="left">Ensure consent is valid for blood transfusion, with patient name, ID and signature, witness name, ID and signature, Dr's name, MCR no. & signature.
                </td>
                <td colspan="5" align="center">
                    <b>
             ...
             <tr>
                <td rowspan="4">13</td>
                <td align="left" rowspan="4">Assess IV site.
               </td>
                <td align="left">Expiry date (≤ 3 days).
                </td>
                <td colspan="5" align="center" rowspan="4">
                    <b>
            ...
            <tr>
                <td align="left">Inspect site for signs of pain, oedema, erythema and increased temperature (POET).
                </td>
            </tr>
            <tr>
                <td align="left">Ensure availability of IV cannula size 19G or larger.
                </td>
            </tr>
            <tr>
                <td align="left">(Verbalise) Flush line to ensure patency of IV line.
                </td>
            </tr>
              <%-- ----------------------------------------------------------------------------- --%> 
             <tr>
                <td >14</td>
                <td align="left" rowspan="4">Receive the blood product from the laboratory.
               </td>
                <td align="left">Check <br/>1)blood unit <br/>2)blood card <br/>3)request form <br/>4)ice pack is in the box.
                ...
                <td rowspan="4">Ensure that the student change from the tubing for blood administration. Hartmanns solution may contain Dextrose 5% which can cause haemolysis and must not be mixed with blood. 
				</td>
            </tr>
            <tr>
                <td >15</td>
                <td align="left">**Priming the blood administration infusion set without contamination.
                </td>
                <td colspan="5" align="center" >
                    <b>
            ...
            <tr>
                <td >16</td>
                <td align="left">Apply critical thinking to explain why Hartmans solution cannot be used prior to blood transfusion
                </td>
                <td colspan="5" align="center" >
                    <b>
            ...
            <tr>
                <td >17</td>
                <td align="left">**Ensure no air bubbles.
                </td>
                <td colspan="5" align="center" >
                    <b>
			 ...
			 <tr>
                <td >18</td>
                <td align="left" rowspan="7">Administer blood product correctly.
               </td>
                <td align="left">**Double-check all labels and expiration date with another nurse.
                </td>
                <td colspan="5" align="center" >
                    <b>
                ...
                <td rowspan="7">TSO:<br/>
					If student does not follow blood administration policy, the patient will question the nurse &quot;Are you sure that this is the right blood for me?&quot;
					<br/>
					Lecturer:<br/>
					**To accord ""0"" mark if student did not perform the highlighted required steps of checking prior blood administration.
			</td>
            </tr>
            <tr>
                <td >19</td>
                <td align="left">Visually inspect blood product.
                </td>
                <td colspan="5" align="center" >
                    <b>
            ...
            <tr>
                <td >20</td>
                <td align="left">**Check blood units and ensure blood is tallied with GXM and blood card.
				</td>
                <td colspan="5" align="center" >
                    <b>
            ...
            <tr>
                <td >21</td>
                <td align="left">**Perform pre-transfusion check with a staff nurse correctly.
                </td>
                <td colspan="5" align="center" >
                    <b>
			 ...
			 <tr>
                 <td >23</td>
                <td align="left">Calculate the flow rate and show workings
                </td>
                 <td colspan="5" align="center" >
                    <b>
			 ...
			 <tr>
                 <td >24</td>
                <td align="left">Administer the blood unit slowly, manually adjust the drip rate to <u>20 drops/min</u> (Total volume = 300mls to run over 4 hours).
                </td>
                 <td colspan="5" align="center" >
                    <b>
            ...
            <%-- ----------------------------------------------------------------------------- --%> 
			 <tr>
                <td >25</td>
                <td align="left" rowspan="4">Monitor for early s/s of blood reactions closely.
               </td>
                <td align="left">**Vital signs every 10-15 minutes, for 1st hour.
                </td>
                <td colspan="5" align="center" >
                    <b>
                ...
                <td rowspan="4">Lecturer:<br/>
				**To accord "0" mark if student did not perform the highlighted required step.
				</td>
            </tr>
            <tr>
                 <td >26</td>
                <td align="left">**Vital signs every 30 minutes for 2nd hour.
                </td>
                <td colspan="5" align="center" >
                    <b>
            ...
            <tr>
                 <td >27</td>
                <td align="left">**Vital signs hourly till completion or according to doctor's order.
				</td>
                <td colspan="5" align="center" >
                    <b>
            ...
            <tr>
                 <td >28</td>
                <td align="left">**Document in hourly parameters chart.
                </td>
                <td colspan="5" align="center" >
                    <b>
            ...
            <tr>
                <td>29</td>
                <td align="left">Recognise the need to inform doctor of status and request for blood product from lab.
                </td>
                <td align="left">Contact the doctor to update the about the blood results and change in condition if any. Contact the blood bank and request for blood product. 
				</td>
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList29" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator
                        ...
                        runat="server"
                        ControlToValidate="RadioButtonList29"
                        ErrorMessage="Select One!"
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </td>
                ...
                <td>Lecturer: Doctor orders to monitor patient closely and administer IM anti emetics as ordered. Student to prepare correct analgesics and PPI in kidney dish for administration by Staff Nurse. 
                </td>
            </tr>
             <%-- ----------------------------------------------------------------------------- --%> 
            <tr>
                <td>30</td>
                <td align="left">Provide proper and timely documentation of procedures in report.
				</td>
                ...
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList30" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator
                        ...
                        runat="server"
                        ControlToValidate="RadioButtonList30"
                        ErrorMessage="Select One!"
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </td>
            ...
            <tr>
                ...
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList31" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator
                        ...
                        runat="server"
                        ControlToValidate="RadioButtonList31"
                        ErrorMessage="Select One!"
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </td>
...
3. Display good leadership and delegation skills.
                ...
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList32" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator
                        ...
                        runat="server"
                        ControlToValidate="RadioButtonList32"
                        ErrorMessage="Select One!"
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </td>
...
2. Good evaluation of patient's condition.


				</td>
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList33" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator
                        ...
                        runat="server"
                        ControlToValidate="RadioButtonList33"
                        ErrorMessage="Select One!"
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </td>
            ...
            <tr>
                ...
                <td colspan="5" align="center">
                    <b>
                        <asp:RadioButtonList RepeatColumns="5" class="style_radio" ID="RadioButtonList34" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table" Width="100%">
                            <asp:ListItem Text="" Value="0"></asp:ListItem>
                            <asp:ListItem Text="" Value="1"></asp:ListItem>
                            <asp:ListItem Text="" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator
                        ...
                        runat="server"
                        ControlToValidate="RadioButtonList34"
                        ErrorMessage="Select One!"
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </td>
