<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V1_1_Simulation1_G4.aspx.cs" Inherits="NSL_V1_1_Simulation1_G4" %>
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="Consolidation Skills 1 (GROUP 4)"
 ...
 <%-- ---------------------------------------------------------------------------------------------%>
              ...
              <tr>
                <td align="left" colspan="11" class="styleCC" style="text-align:justify">
                    Brief Summary:
                    <br />
                Mr. Mohd Ali, 70-years-old nursing home resident with indwelling urinary catheter in situ was admitted to the hospital due to fever. He was diagnosed with urine tract infection. 
 <br /> <br />
				Group tasks:
 <br />Nurse 1 & 2: Perform Bed bath, empty the urine bag and provide the care for patient with urinary catheter.
 <br />Nurse 3: Educate and assist Mr. Mohd Ali with passive range of motion (Knee and Ankle).
 <br />Nurse 4 & 5: To calculate patient’s BMI by assisting him to measure his height and weight. 
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
		  ...
		  <%---------------------------------------------------------------------------------------------------------------------------------------------%>
			<tr>
					<td>11</td>
					<td align="left" rowspan="3">Empty the urine bag without contamination.
					</td>
					<td align="left">Swap the tip/outlet of the urine bag with an alcohol swab and wait for the alcohol to dry before and after emptying the bag. (Ensure that student uses 2 new alcohol swab)
					</td>
					<td  colspan="5" align="center" >
		...
		<tr>
					...
					<td align="left">Drain the volume of urine into the measuring jug.
		...
		<tr>
					...
					<td align="left">Patient's urine is measured and recorded accurately in I/O chart.
			...
			<tr>
					...
					<td align="left">Knee (Flexion & extension) Repeat the exercises at least five times and perform each motion in a slow, firm manner.
					</td>
					<td  colspan="5" align="center" >
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				<tr>
					...
					<td align="left">Ankle (Flexion and extension, plantar flexion, dorsiflexion and eversion and inversion) Repeat the exercises at least five times and perform each motion in a slow, firm manner.
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					<td>17</td>
					<td align="left" rowspan="6">Assist patient to ambulate to obtain an accurate calculation of BMI
					</td>
					<td align="left">Assess patient’s condition:  
</br>a. Level of mobility 
</br>b. Weak side 
</br>c. Pain or confusion 
</br>d.Level of understanding and cooperation 
</br>e.Need for assistance from other healthcare workers
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Assist the patient safely from bed to a standing position.
			...
			<tr>
					...
					<td align="left">Assist the patient safely to measure his height and weight. 
				...
				<tr>
					...
					<td align="left">Assist the patient safely back to bed.
	...
	<tr>
					...
					<td align="left">Carefully attend to catheter. Ensure urinary bag is below patient’s bladder at all times.
				...
				<tr>
					...
					<td align="left">Calculate and interpret the BMI accurately.
