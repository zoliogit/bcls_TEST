<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="staff_details.aspx.cs" Inherits="staff_details" %>

<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    <title>staffdetails-BCLS</title>
                    ...
                    <td align="center" class="styleCC">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="staff_nric" HeaderText="NRIC" ItemStyle-HorizontalAlign="Left"
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#98272d"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkdelete" ForeColor="Black" runat="server" OnClick="lnkdelete_Click">Delete</asp:LinkButton>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#98272d"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkstaff" runat="server" ForeColor="Black" CommandArgument='<%#Eval("staff_id")%>'
                                            CommandName="select">Report</asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#98272d"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkpass" runat="server" ForeColor="Black" CommandArgument='<%#Eval("staff_id")%>'
