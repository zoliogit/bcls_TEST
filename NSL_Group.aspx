<%@ Page Language="C#" MasterPageFile="~/NSL_MasterPage.master" AutoEventWireup="true" EnableEventValidation ="false" CodeFile="NSL_Group.aspx.cs" Inherits="NSL_Group" Title="Untitled Page" %>
...
onrowupdating="UpdateStudent"  onrowcancelingedit="CancelEdit"  OnRowDataBound="GridView1_RowDataBound">
                        ...
                        <Columns>
                          ...
                          <asp:TextBox ID="txtgroup" runat="server"></asp:TextBox>
                              ...
                              <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "ACS- %">
                             <ItemTemplate>
                          ...
                          <asp:TextBox ID="txtsim1" runat="server"></asp:TextBox>
                            ...
                            <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "ACS- Comments">
                             <ItemTemplate>
                          ...
                          <asp:TextBox ID="txtsim1_remarks" runat="server"></asp:TextBox>
                                 ...
                                 <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "BT- %">
                             <ItemTemplate>
                          ...
                          <asp:TextBox ID="txtsim2" runat="server"></asp:TextBox>
                             ...
                             <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "BT- Comments">
                             <ItemTemplate>
                             <asp:Label ID="lblsim2_remarks" runat="server" 
                             Text='<%# Eval("edited_score_remarks_sim2")%>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                            <asp:TextBox ID="txtsim2_remarks" runat="server" TextMode="MultiLine"
                            Text='<%# Eval("edited_score_remarks_sim2")%>'></asp:TextBox>
                           </EditItemTemplate> 
                          <FooterTemplate>
                          <asp:TextBox ID="txtsim2_remarks" runat="server"></asp:TextBox>
                          </FooterTemplate>
                          </asp:TemplateField>
                         
                         
                          <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "TC- %">
                             <ItemTemplate>
                             <asp:Label ID="lblsim3" runat="server"
                             Text='<%# Eval("percent_score_sim3")%>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                            <asp:TextBox ID="txtsim3" runat="server"
                          ...
                          <FooterTemplate>
                          <asp:TextBox ID="txtsim3" runat="server"></asp:TextBox>
                          </FooterTemplate>
                          </asp:TemplateField>  
                             
                               <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "TC- Comments">
                             <ItemTemplate>
                             <asp:Label ID="lblsim3_remarks" runat="server"
                             Text='<%# Eval("edited_score_remarks_sim3")%>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                            <asp:TextBox ID="txtsim3_remarks" runat="server" TextMode="MultiLine"
                            Text='<%# Eval("edited_score_remarks_sim3")%>'></asp:TextBox>
                            
                           </EditItemTemplate> 
                          <FooterTemplate>
                          <asp:TextBox ID="txtsim3_remarks" runat="server"></asp:TextBox>
                          </FooterTemplate>
                          </asp:TemplateField>
                       
                   <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "MGC- %">
                             <ItemTemplate>
                             <asp:Label ID="lblmgc" runat="server"
                             Text='<%# Eval("percent_score_mgc")%>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                            <asp:TextBox ID="txtmgc" runat="server"
                            Text='<%# Eval("percent_score_mgc")%>'></asp:TextBox>
                            <asp:RangeValidator ID="RangeValidatormgc" runat="server" ControlToValidate="txtmgc"
                            MinimumValue="0" MaximumValue="2147483647" Type="Double" Text="Invalid" ValidationGroup="Group1" />
         
                           </EditItemTemplate> 
                          <FooterTemplate>
                          <asp:TextBox ID="txtmgc" runat="server"></asp:TextBox>
                           
                          </FooterTemplate>
                          </asp:TemplateField>
                            
                               <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "MGC- Comments">
                             <ItemTemplate>
                             <asp:Label ID="lblmgc_remarks" runat="server"
                             Text='<%# Eval("edited_score_remarks_mgc")%>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                            <asp:TextBox ID="txtmgc_remarks" runat="server"  TextMode="MultiLine"
                            Text='<%# Eval("edited_score_remarks_mgc")%>'></asp:TextBox>
                           </EditItemTemplate> 
                          <FooterTemplate>
                          <asp:TextBox ID="txtmgc_remarks" runat="server"></asp:TextBox>
                          </FooterTemplate>
                          </asp:TemplateField>
