<%@ Page Language="C#" MasterPageFile="~/NSL_MasterPage.master" AutoEventWireup="true" EnableEventValidation ="false" CodeFile="NSL_Group_V2_1.aspx.cs" Inherits="NSL_Group_V2_1" Title="Untitled Page" %>

<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    <title>Group-NSL V2.1</title>
...
onrowupdating="UpdateStudent"  onrowcancelingedit="CancelEdit"  OnRowDataBound="GridView1_RowDataBound">
                        ...
                        <Columns>
                          ...
                          <asp:TextBox ID="txtgroup" runat="server"></asp:TextBox>
                              ...
                              <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "SIM1- %">
                             <ItemTemplate>
                          ...
                          <asp:TextBox ID="txtsim1" runat="server"></asp:TextBox>
                            ...
                            <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "SIM1- Comments">
                             <ItemTemplate>
                          ...
                          <asp:TextBox ID="txtsim1_remarks" runat="server"></asp:TextBox>
                                 ...
                                 <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "SIM2- %">
                             <ItemTemplate>
                          ...
                          <asp:TextBox ID="txtsim2" runat="server"></asp:TextBox>
                             ...
                             <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "SIM2- Comments">
                             <ItemTemplate>
                          ...
                          <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "SIM3- %">
                             <ItemTemplate>
                          ...
                          <asp:TextBox ID="txtsim3" runat="server"></asp:TextBox>
                               ...
                               <asp:TemplateField ItemStyle-Width = "70px" HeaderStyle-BackColor="#98272d" ItemStyle-HorizontalAlign="Center" HeaderText = "SIM3- Comments">
                             <ItemTemplate>
