<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="student_NRIC_search.aspx.cs" Inherits="student_NRIC_search" Title="Untitled Page" %>
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    <title>Students_searchNRIC-BCLS </title>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="X-Large" ForeColor="Black"
        Text="Students Details" Font-Names="Arial"></asp:Label>
</asp:Content>
                    ...
                    <td class="styleCC" align="center" bgcolor="White">
                        ...
                        <p>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                ForeColor="#333333" CellSpacing="2" Width="859px"  
                                ...
                                <Columns>
                                  ...
                                  <asp:BoundField DataField="student_nric" ItemStyle-HorizontalAlign="Center" HeaderText="Student_NRIC"
                                    ...
                                    <%--  <asp:TemplateField ShowHeader="true" HeaderText="Student_NRIC" HeaderStyle-BackColor="#98272d"
                                    ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lb_student_nric" runat="server" ForeColor="Black" CausesValidation="false"
                                            CommandName="select_student_nric" Text='<%# Eval("student_nric")%>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
