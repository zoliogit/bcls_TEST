<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_Simulation3_opt2.aspx.cs" Inherits="NSL_Simulation3_opt2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Tracheostomy Care - Suctioning</title>
            ...
            <tr>
                <td bgcolor="#F7F6F3" class="styleCC">
                    ...
                    <asp:Label ID="Label161" runat="server" Font-Bold="False" Font-Size="X-Large" ForeColor="Black"
                        Text="Tracheostomy Care - SUCTIONING" Font-Names="Arial"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
        ...
        <table bgcolor="White" border="1" bordercolor="#98272d" style="border-collapse: collapse;
             ...
             <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="style9" bgcolor="#98272D" 
                    ...
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" Text= "OPTION 2 (SUCTIONING)"
            ...
            <%-- ---------------------------------------------------------------------------------------------%>
                ...
                <td align="center" colspan="11" bgcolor="#98272D">
                    <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Size="Large" Text="Tracheostomy Suctioning"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
...
<br />Drug Allergy: NKDA
            ...
            <tr >
                <td align="left" colspan="10" >
                    <asp:Label ID="Label5" runat="server" Text="Current situation: At 1330 hours, the morning shift is handing over the case to your team. Demonstrate the plan of care after taking over the patient."
...
State 2: Severe respiratory distress</br>
Increase HR to 105bpm, RR-35b/min, SpO2-89%, BP-160/90mmHg. </br>
TSO/Lecturer: </br>
To activate coughing and difficulty in breathing.
...
Breath sounds - crackles
            ...
            <tr>
                ...
                <td class="font-italic">
                    Last suctioning was done at 1030hr with minimal secretion (4hrs from current 
                    time).</td>
            </tr>
                     <%---------------------------15--------------------------------%>
            <tr>
            ...
            <tr>
                ...
                <td rowspan="7" class="font-italic">
                    Note: 
                    <br />
                    **Accord &quot;0&quot; mark to the respective steps if the student failed to perform 
...
This state is activated if students have performed the suctioning procedure satisfactory.   <br />
Note:   <br />
**Accord ""0"" mark if bolded step/s is not done. To deduct marks when student perform tracheostomy suctioning without checking parameters.
 ...
 <%----------------------------35--------------------------------%>
            ...
            <tr>
                ...
                <td class="style8" rowspan="2">
                    ...
                    <asp:TextBox ID="remarks39" runat="server" TextMode="MultiLine"    class="RemarksTextarea" 
            ...
            <tr>
                ...
                <td colspan="5" align="center" rowspan="6">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator42" runat="server" 
                        ControlToValidate="RadioButtonList42" ErrorMessage="Select One!" ForeColor="Red">
                    </asp:RequiredFieldValidator>
                     </td>
