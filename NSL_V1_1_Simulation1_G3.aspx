<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V1_1_Simulation1_G3.aspx.cs" Inherits="NSL_V1_1_Simulation1_G3" %>
...
<head id="Head1" runat="server">
    ...
    <title>V1.1-Consolidation 1</title>
            ...
            <tr>
                <td bgcolor="#F7F6F3" class="styleCC">
                  ...
                  <asp:Label ID="Label161" runat="server" Font-Bold="False" Font-Size="X-Large" ForeColor="Black"
                        Text="CONSOLIDATION 1" Font-Names="Arial"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="Consolidation Skills 1 (GROUP 3)"
                       ...
                       <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="Medium" Text="Select Option"
                        Font-Names="Arial" ForeColor="White"></asp:Label><asp:DropDownList ID="dl_option" runat="server" Style="margin-left: 8px;
                                    ...
                                    <asp:ListItem Text="GROUP 3" Value="3"></asp:ListItem>
                                    <asp:ListItem Text="GROUP 4" Value="4"></asp:ListItem>
                                    <asp:ListItem Text="GROUP 1" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="GROUP 2" Value="2" ></asp:ListItem>
 ...
 <%-- ---------------------------------------------------------------------------------------------%>
              ...
              <tr>
                <td align="left" colspan="11" class="styleCC" style="text-align:justify">
                    Brief Summary:
                    <br />
            <br />  Mr. James Kong, 55-years-old was admitted to hospital for right side weakness. He was diagnosed with left cerebrovascular accident (CVA). He is drooling badly and has swallowing difficulty. Dr has ordered for strict intake and output monitoring. 
 <br /> <br />Group task:
 <br />Nurse 1 & 2: Perform bed-bath and oral hygiene for Mr Kong.
 <br />Nurse 3 & 4: Apply urosheath for Mr. Kong and provide the care of patient on urosheath. To sit Mr. Kong out of bed as doctor has ordered to sit patient out of bed three (3) times per day to reduce the risk for getting hospital required pneumonia.
 <br />Nurse 5 : Educate and assist Mr. Kong with range of motion exercise (Neck, shoulder, elbow and wrist) while he is sitting on the chair.
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
           ...
           <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				<tr>
					<td>8</td>
					<td align="left" rowspan="3">Providing Oral care 
					</td>
					<td align="left" >The patient’s oral hygiene is performed safely with clear instructions given.  
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					<td>10</td>
					<td align="left" >The patient’s oral hygiene is performed safely with clear instructions given.  </td>
			...
			<tr>
					<td>11</td>
					<td align="left" rowspan="3">Providing bed bath correctly 
					</td>
					<td align="left">Perform cleaning of patient's face, upper body, extremities, abdomen and back.
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					...
					<td align="left">Provide care for patient's genital area.
				...
				<tr>
					...
					<td align="left">Performed bed bath to a patient in bed without contamination and not compromising patient's safety.
					</td>
					<td  colspan="5" align="center" >
       ...
       <tr>
					<td>14</td>
					<td align="left" rowspan="3">Applying and Care of patient on Urosheath
					</td>
					<td align="left">Assess condition of the penis and perineal area for signs of irritation or skin breakdown. Shave any excess hair around the base of the penis if necessary.
				 ...
				 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
					...
					<td align="left">Apply urosheath in correct manner w/o leakage or discomfort.
				...
				<tr>
					...
					<td align="left">Secure the drainage bag at the side of the bed below the level of patient’s bladder. Ensure that the tip of the drainage bag does not touch the floor and the tubing is not kinked.
				...
				<tr>
					<td>17</td>
					<td align="left" rowspan="3">Transfer patient from bed to chair.
					</td>
					<td align="left">Assess patient's condition (level of mobility, weak side, pain or confusion, level of cooperation and need for assistance from other healthcare workers)and any impediments such as IV tubing, urinary bag or drainage bottles
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					...
					<td align="left">Chair is placed at patient’s strong side with 45 degree angle to the bed.
				...
				<tr>
					...
					<td align="left">Transferred the patient to the chair without compromising patient’s safety.
				...
				<tr>
					<td>20</td>
					<td align="left" rowspan="3">Perform ROM on patient.
					</td>
					<td align="left">Neck (Rotation, flexion & extension, lateral flexion) Repeat the exercises at least five times and perform each motion in a slow, firm manner.
				...
				<tr>
					...
					<td align="left">Elbow (flexion and extension, pronation and supination) Repeat the exercises at least five times and perform each motion in a slow, firm manner.
				...
				<tr>
					...
					<td align="left">Encourage full joint movement, but do not go beyond the point of pain, resistance or fatigue.
