<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_2_Simulation2_G1.aspx.cs" Inherits="NSL_V2_2_Simulation2_G1" %>
 ...
 function  show_score()
{
 ...
 if (rb != null)
    ...
    actual_score_float = (parseInt(total_score) / 112) * (5 / 100) * 100;//Total/112 X 5% 
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="SIM2-OPTION 1"
...
Accord "0" if did not check the patient's name and ID against the chart.
</br></br>
...
Bowel sounds-hyperactive</td>
                ...
                <td  colspan="5" align="center" >
                    ...
                    </b><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                ...
                <td>
                    9</td>
                <td align="left">
                   Pain assessment: Use of OLDCART, pain score   <br/>
- Patient complaints of severe pain at the left calf</td>
                <td  colspan="5" align="center" >
...
- Able to lift up the upper limb but have difficulty in lifting the left leg and swelling seen on the left leg.</td>
            </tr>                
            <%--   ------------------------------------------------------------------  --%>
...
- Left calf warm to touch</br> 
- Slight oedema in left calf seen
 </td>
                <td  colspan="5" align="center" >
                ...
                <td>
                    Lecturer: </br>
** Accord "0" mark if student:</br>
- did not check the neurovascular assessment. </td>
...
- did not assess the surgical wound dressing: dressing is dry and intact.  
              ...
              <%--   ------------------------------------------------------------------  --%>
                ...
                <td>
                    13</td>
                <td align="left" >
                    Call doctor to inform patient complaints of severe pain at the left calf</td>
                <td align="left">
...
** Accord "0" mark if student:</br>
- Inefficient update of the parameter reading./td>           </tr>                
          <%--  ----------------------------------------------------------------------%>
...
- Adminster the medications as ordered</br>

- Elevate the leg above the heart level</td>
...
- did not carry out doctor's orders timely and correctly.</td>           </tr>   
             ...
             <%--  ----------------------------------------------------------------------%>
                ...
                <td class="style9">
                    15</td>
                <td align="left" class="style9" rowspan="4" >
...
- did not observe for side effects of the medications.</td>           </tr>   
...
- did not observe for signs of fluid overload (dyspnoea, breathlessness, cyanosis). </td>
               ...
               <tr>
                ...
                <td align="left" rowspan="2" >
                    Re-evaluate patient's pain score after administer medications  </td>
                <td align="left">
                    Re-evaluate patient's pain score  after 30 minutes</td>
                <td  colspan="5" align="center" >
...
4                 </td>
               ...
               <tr>
                <td>
                    24</td>
                <td align="left" >
                    Monitor intake and output</td>
                <td align="left">
                    To monitor intake and output :<br/>
- Patient urine output 800mLs
</td>
                <td  colspan="5" align="center" >
                ...
                <td>
                    Lecturer: </br> ** Accord "0" mark if student:  </br>
- did not monitor intake and output. 
</td>
            </tr>                
...
Patient's vital signs, pain status and patient education (if required)
</td>
                <td  colspan="5" align="center" >
                ...
                <td>
                    Lecturer:</br> 
** Accord "0" mark if student did not:  </br> 
...
Good evaluation of patient's condition</td>
                ...
                <td class="style11">
                    Lecturer:</br> Deduct marks to "1" or "2" marks for this category if students:</br>
- did not inform the doctor immediately when patient complaints of severe pain at left calf.</td>
            </tr>                
          ...
          <tr>
                ...
                <td colspan="5" align="center">
                    &nbsp;</td>
                <td align="center">
                    <asp:Label ID="Label60" runat="server" Font-Names="Arial" Font-Bold="true" Text="112"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
                <td>
       ...
       CausesValidation="false" 
            ...
            <tr>
              ...
              </br>  <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Bold="true" Text="Total/112 X 5% "></asp:Label>
                </td>
                <td colspan="8" align="left">
                    &nbsp;</td>
            </tr>
