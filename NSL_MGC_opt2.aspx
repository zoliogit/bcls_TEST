<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_MGC_opt2.aspx.cs" Inherits="NSL_MGC_opt2" %>
...
//actual_score_float = (parseInt(total_score) /606) *   100;//Total/176 X 4% 
 actual_score_float = (parseInt(total_score) / 598) * (10 / 100) * 100;//Total/612 X 8% 
   ...
   <div style="font-family: Arial; height: 100%;">
        <table style="display: inline-table;" class="style1" width="100">
            <tr>
                ...
                <td class="styleAA" align="center" style="background-image: url(images/navigationBar.png)"
                    colspan="2">
                    <asp:Label ID="Labelaa2" runat="server" Font-Bold="False" Font-Size="XX-Large" Font-Strikeout="False"
            ...
            <tr>
                <td bgcolor="#F7F6F3" class="styleCC">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label161a" runat="server" Font-Bold="False" Font-Size="X-Large" ForeColor="Black"
    ...
    <div align="center" style="font-family: Arial; height: 100%; width: 100%;">
        ...
        <table bgcolor="White" border="1" align="center" bordercolor="#98272d" style="border-collapse: collapse;
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="Labela14" runat="server" Font-Bold="True" Font-Size="Large" Text="Name of assessor"
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="Labelaa16" runat="server" Font-Bold="True" Font-Size="Medium" Text="Actual Percentage"
                        Font-Names="Arial"></asp:Label>
                </td>
                <td>
                    <b>
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="Labela18" runat="server" Font-Bold="True" Font-Size="Medium" Text="Date of Assessment"
                        Font-Names="Arial"></asp:Label>
                </td>
                <td>
                    <b>
        ...
        <table bgcolor="White" border="1" bordercolor="#98272d" style="border-collapse: collapse;
            ...
            <tr>
                <td align="left" colspan="11" 
                   ...
                   * Please take note that some management/ interventions are done 
                    simultaneously and the checklist here serves as a guide for grading. Some skills can
                    be done in sequence as shown in the list but it can also be done later if necessary.</td>
                <td align="left" 
                    style="border: 1px solid white;">
                    &nbsp;</td>
            </tr>
               ...
               <tr>
                <td align="left" colspan="12" class="styleCC" bgcolor="#98272D" 
                       style="border: 1px solid white;">
                    <asp:Label ID="Labela1" runat="server" Font-Bold="True" Font-Size="Large" Text= "OPTION 2 (Pulseless VT)"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                        
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Label ID="Labela6" runat="server" Font-Bold="True" Font-Size="Medium" Text="Select Option"
            ...
            <tr>
                <td align="center" colspan="12" bgcolor="#98272D" 
                    style="border: 1px solid white;">
                    <asp:Label ID="Labela21" runat="server" Font-Bold="True" Font-Size="Large" Text="MEGACODE PRACTICAL TEST"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="border: 1px solid white;" bgcolor="#98272D" align="left" colspan="3">
                     <b ><font color="White" face="Arial">Pulseless Ventricular Tachycardiac<br />
Brief Summary: <br />
Mdm Lee Ho Yin is noted to be unconscious when you are about to take her parameters.</font></b>
                ...
                <td align="center" colspan="7" bgcolor="#98272D" 
                    style="border: 1px solid white;">
                    <asp:Label ID="Label163a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Score"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td align="center" bgcolor="#98272D" style="border: 1px solid white;" rowspan="2">
                    <asp:Label ID="Label5a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Remarks"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td align="center" bgcolor="#98272D" style="border: 1px solid white;" rowspan="2">
                    <asp:Label ID="Label176a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Action by TSO or Lecturers"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <%--  -------------------------------------------------------------------------------- --%>
            ...
            <td bgcolor="#98272D" align="left" style="border: 1px solid white;" class="">
                    <asp:Label ID="Label173a" runat="server" Font-Bold="True" Font-Size="Medium" Text="SN"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td bgcolor="#98272D" align="left" style="border: 1px solid white;" class="">
                    <asp:Label ID="Label3a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Passing Criteria"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                
                <td style="border: 1px solid white;" bgcolor="#98272D" align="left" style="border: 1px solid white;">
                    <asp:Label ID="Label165a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Tester's Response"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td align="center" bgcolor="#98272D" style="border: 1px solid white;">
                    <asp:Label ID="Label166a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Raw Score"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td align="center" bgcolor="#98272D" style="border: 1px solid white;" 
                    style="border: 1px solid white;" >
                    <asp:Label ID="Label167a" runat="server" Font-Bold="True" Font-Size="Medium" Text="C"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td align="center" bgcolor="#98272D" style="border: 1px solid white;">
                    <asp:Label ID="Label168a" runat="server" Font-Bold="True" Font-Size="Medium" Text="D"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td align="center" colspan="2" bgcolor="#98272D" style="border: 1px solid white;"
                    style="border: 1px solid white;">
                    <asp:Label ID="Label169a" runat="server" Font-Bold="True" Font-Size="Medium" Text="C*D"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td align="center" bgcolor="#98272D" style="border: 1px solid white;" style="border: 1px solid white;">
                    <asp:Label ID="Label170a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Max Score"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
                <td align="center" bgcolor="#98272D" style="border: 1px solid white;" style="border: 1px solid white;">
                    <asp:Label ID="Label172a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Actual Score"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <%--  -------------------------------------------------------------------------------- --%>
            ...
            <td align="left">
                ...
                <td align="center" bgcolor="#ffcccc">
                  <asp:RadioButtonList ID="RadioButtonList1" runat="server" class="style_radio" 
                        onclick="GetRDBValue1();" RepeatColumns="7" RepeatDirection="Horizontal" 
                    ...
                    <asp:RequiredFieldValidator ID="ReqiredFieldValidator1" runat="server" 
                        ControlToValidate="RadioButtonList1" ErrorMessage="Select One!" ForeColor="Red">
            ...
            <td align="left">
                ...
                <td align="center" bgcolor="#ffcccc">
                   <asp:RadioButtonList ID="RadioButtonList2" runat="server" 
                        class="style_radio" onclick="GetRDBValue2();" RepeatColumns="7" 
                    ...
                    <asp:RequiredFieldValidator ID="ReqiredFieldValidator2" runat="server" 
...
1) Persistent patent airway by performing head tilt chin lift        <br />                        
...
3) Check carotid pulse
                ...
                <td align="center" bgcolor="#ffcccc">
                 <asp:RadioButtonList ID="RadioButtonList3" runat="server" 
                        class="style_radio" onclick="GetRDBValue3();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator ID="ReqiredFieldValidator3" runat="server" 
...
4)Apply manual resuscitator correctly after oral airway insertion</td>
                ...
                <td align="center" bgcolor="#ffcccc">
                  <asp:RadioButtonList ID="RadioButtonList4" runat="server" 
                        class="style_radio" onclick="GetRDBValue4();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator ID="ReqiredFieldValidator4" runat="server" 
            ...
            <td align="left">
                ...
                <td align="center" bgcolor="#ffcccc">
                    <asp:RadioButtonList ID="RadioButtonList5" runat="server" 
                        class="style_radio" onclick="GetRDBValue5();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                  
                    </asp:RadioButtonList>
                    <asp:RequiredFieldValidator ID="ReqiredFieldValidator5" runat="server" 
            ...
            <td align="left">
                ...
                <td align="left">
                    D:<br />
                    1) Attach ECG leads to patient correctly
                    <br />
                    2) Select lead II
                    <br />
                    3) Analyse rhythm </td>
                ...
                <td align="left">
                    Select pulseless VT</td>
                <td align="center" bgcolor="#ffcccc">
                    <asp:RadioButtonList ID="RadioButtonList6" runat="server" 
                        class="style_radio" onclick="GetRDBValue6();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
            ...
            <td align="left" class="">
                    7</td>
                <td align="left" class="">
                   1) Interpret rhythm correctly<br />
2) Check carotid pulse</td>
                ...
                <td align="center" bgcolor="#ffcccc" class="">
                    <asp:RadioButtonList ID="RadioButtonList7" runat="server" 
                        class="style_radio" onclick="GetRDBValue7();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
            ...
            <td align="left" class="">
                ...
                <td align="center" bgcolor="#ffcccc" class="">
                    <asp:RadioButtonList ID="RadioButtonList8" runat="server" 
                        class="style_radio" onclick="GetRDBValue8();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
...
1) Apply defibrillation gel pads to patient correctly<br />
...
5) Confirm rhythm is VT by looking at the monitor screen<br />
6) Then discharge with eyes looking at the monitor  </td>
                ...
                <td align="center" bgcolor="#ffcccc" class="">
                   <asp:RadioButtonList ID="RadioButtonList9" runat="server" 
                        class="style_radio" onclick="GetRDBValue9();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
            ...
            <td align="left" >
                ...
                <td align="center" bgcolor="#ffcccc" >
                  <asp:RadioButtonList ID="RadioButtonList10" runat="server" 
                        class="style_radio" onclick="GetRDBValue10();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
            ...
            <td align="left" class="">
                ...
                <td align="left" class="">
                   Secondary ABCD:<br />
1) Establish IV access correctly and safely/ Assess for availability of 
                    IV access (this should be performed by the IV nurse while the other members are placing airway device)<br />
2) Prepare Normal Saline solution</td>
                
                <td align="left" class="">
                    Persistent VT</td>
                <td align="center" bgcolor="#ffcccc" class="">
                 <asp:RadioButtonList ID="RadioButtonList11" runat="server" 
                        class="style_radio" onclick="GetRDBValue11();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                    <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
2) Normal saline for flushing</td>
               ...
               <asp:RadioButtonList ID="RadioButtonList12" runat="server" 
                        class="style_radio" onclick="GetRDBValue12();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
2) Administer IV N/S infusion fast</td>
                ...
                <td align="center" bgcolor="#ffcccc" class="">
                 <asp:RadioButtonList ID="RadioButtonList13" runat="server" 
                        class="style_radio" onclick="GetRDBValue13();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
4) Secure tube correctly<br />
 (Allows this step to do later if necessary)</td>
                
                <td align="left" class="">
                    &nbsp;</td>
                <td align="center" bgcolor="#ffcccc" class="">
                 <asp:RadioButtonList ID="RadioButtonList14" runat="server" 
                        class="style_radio" onclick="GetRDBValue14();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator ID="ReqiredFieldValidator14" runat="server" 
            ...
            <td align="left" class="">
                ...
                <td align="center" bgcolor="#ffcccc" class="">
                   <asp:RadioButtonList ID="RadioButtonList15" runat="server" 
                        class="style_radio" onclick="GetRDBValue15();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        
                    </asp:RadioButtonList>
                    <asp:RequiredFieldValidator ID="ReqiredFieldValidator15" runat="server" 
            ...
            <td align="left" class="">
                ...
                <asp:RadioButtonList ID="RadioButtonList16" runat="server" 
                        class="style_radio" onclick="GetRDBValue16();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator ID="ReqiredFieldValidator16" runat="server" 
...
4) Confirm rhythm is VT by looking at the monitor screen<br />
5) Then discharge with eyes looking at the monitor </td>
                ...
                <asp:RadioButtonList ID="RadioButtonList17" runat="server" 
                        class="style_radio" onclick="GetRDBValue17();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
2) Administer IV Adrenaline 1mg(1:10,000)</td>
            ...
            <td align="left" class="">
                ...
                <asp:RadioButtonList ID="RadioButtonList19" runat="server" 
                        class="style_radio" onclick="GetRDBValue19();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
Persistent pulseless VT</td>
             ...
             <asp:RadioButtonList ID="RadioButtonList20" runat="server" 
                        class="style_radio" onclick="GetRDBValue20();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
            ...
            <td align="left" class="">
                ...
                <td align="center" bgcolor="#ffcccc" class="style7">
                    <asp:RadioButtonList ID="RadioButtonList21" runat="server" 
                        class="style_radio" onclick="GetRDBValue21();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
...
IV Lignocaine 50-100mg IV bolus</td>
                ...
                <td align="left" class="style3">
                   Neat dose OR diluted in 20mls D5W</td>
                <td align="center" bgcolor="#ffcccc" class="style7">
                    <asp:RadioButtonList ID="RadioButtonList22" runat="server" 
                        class="style_radio" onclick="GetRDBValue22();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
            ...
            <td align="left" >
                ...
                <td align="center" bgcolor="#ffcccc" class="style7">
                    <asp:RadioButtonList ID="RadioButtonList23" runat="server" 
                        class="style_radio" onclick="GetRDBValue23();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
5) Then discharge with eyes looking at the monitor </td>
           ...
           <asp:RadioButtonList ID="RadioButtonList24" runat="server" 
                        class="style_radio" onclick="GetRDBValue24();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
            ...
            <td align="left" class="">
                ...
                <td align="center" bgcolor="#ffcccc" class="style7">
                   <asp:RadioButtonList ID="RadioButtonList25" runat="server" 
                        class="style_radio" onclick="GetRDBValue25();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
            ...
            <td align="left" class="">
                ...
                <td align="center" bgcolor="#ffcccc" class="style7">
                 <asp:RadioButtonList ID="RadioButtonList26" runat="server" 
                        class="style_radio" onclick="GetRDBValue26();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
            ...
            <td align="left" class="">
                ...
                <asp:RadioButtonList ID="RadioButtonList27" runat="server" 
                        class="style_radio" onclick="GetRDBValue27();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
3) Verbalise to administer Dopamine and its rationale</td>
            ...
            <asp:RadioButtonList ID="RadioButtonList28" runat="server" 
                        class="style_radio" onclick="GetRDBValue28();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
3) C- Circulation line to secure, CXR (verbalise)
                ...
                <td align="center" bgcolor="#ffcccc" class="style7">
                   <asp:RadioButtonList ID="RadioButtonList29" runat="server" 
                        class="style_radio" onclick="GetRDBValue29();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
4) G- Insert NGT to decompress stomach</td>
                ...
                <td align="center" bgcolor="#ffcccc" class="style7">
                 <asp:RadioButtonList ID="RadioButtonList30" runat="server" 
                        class="style_radio" onclick="GetRDBValue30();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
5)E-drug kit</td>
             ...
             <asp:RadioButtonList ID="RadioButtonList31" runat="server" 
                        class="style_radio" onclick="GetRDBValue31();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
6) Outcome of resuscitation</td>
                ...
                <td align="center" bgcolor="#ffcccc" class="style7">
                 <asp:RadioButtonList ID="RadioButtonList32" runat="server" 
                        class="style_radio" onclick="GetRDBValue32();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
...
8) Name of the doctor informed
                ...
                <td align="center" bgcolor="#ffcccc" class="style8">
                   <asp:RadioButtonList ID="RadioButtonList33" runat="server" 
                        class="style_radio" onclick="GetRDBValue33();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
            ...
            <td align="left" class="">
                    34</td>
                <td align="left" class="">
                  Handover to the staff nurse of ICU</td>
                
                <td align="left" class="">
                    &nbsp;</td>
                <td align="center" bgcolor="#ffcccc" class="style7">
                    <asp:RadioButtonList ID="RadioButtonList34" runat="server" 
                        class="style_radio" onclick="GetRDBValue34();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
            ...
            <td align="left" class="">
                    35</td>
                <td align="left" class="">
                    Role of team members are well defined.</td>
                
                <td align="left" class="">
                    &nbsp;</td>
                <td align="center" bgcolor="#ffcccc" class="style7">
                   <asp:RadioButtonList ID="RadioButtonList35" runat="server" 
                        class="style_radio" onclick="GetRDBValue35();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
            ...
            <td align="left" class="">
              ...
              <asp:RadioButtonList ID="RadioButtonList36" runat="server" 
                        class="style_radio" onclick="GetRDBValue36();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
                        <asp:ListItem Text="2" Value="2"></asp:ListItem>
            ...
            <td align="left" class="style5">
                ...
                <td align="center" bgcolor="#ffcccc" class="style7">
                 <asp:RadioButtonList ID="RadioButtonList37" runat="server" 
                        class="style_radio" onclick="GetRDBValue37();" RepeatColumns="7" 
                        RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="0" Value="0"></asp:ListItem>
                        <asp:ListItem Text="1" Value="1"></asp:ListItem>
            ...
            <%--  ----------------------------------------------------------------------%>
                ...
                <%--  ----------------------------------------------------------------------%>
            <tr>
            <td align="right" class="style5" colspan="9">
                    <asp:Label ID="Label174a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Actual Total Mark"
                        Font-Names="Arial" ></asp:Label>
                </td>
                <td align="center" class="style5" bgcolor="#9fdfbf" >
            ...
            <tr>
            <td align="right" class="style5" colspan="9">
                    <asp:Label ID="Label175a" runat="server" Font-Bold="True" Font-Size="Medium" Text="Actual Percentage"
                        Font-Names="Arial" ></asp:Label>
                </td>
                <td align="center" class="style5" bgcolor="#9fdfbf" >
       ...
       CausesValidation="false"
        ...
        <br />
        2. Follow SBAR when calling the doctor.</font>
    </div>
    <div align="center">
