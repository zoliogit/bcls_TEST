<%@ Page Title="" Language="C#" MasterPageFile="~/NSL_MasterPage.master" AutoEventWireup="true" CodeFile="NSL_All_Groups_v1_1.aspx.cs" Inherits="NSL_All_Groups_v1_1" %>


<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    <title>All Groups-NSL V1.1</title>
...
>
                 ...
                 <asp:BoundField DataField="percent_score_sim1" ItemStyle-HorizontalAlign="Left" HeaderText="CON1- %"
                                HeaderStyle-BackColor="#98272d" SortExpression="percent_score_sim1" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="left"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="edited_score_remarks_sim1" ItemStyle-HorizontalAlign="Left" HeaderText="CON1- Comments"
                                HeaderStyle-BackColor="#98272d" SortExpression="edited_score_remarks_sim1" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="left"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="submitted_staff_sim1" ItemStyle-HorizontalAlign="Left" HeaderText="CON1- Submitted By"
                 ...
                 <asp:BoundField DataField="percent_score_sim2" ItemStyle-HorizontalAlign="Left" HeaderText="CON2- %" 
                        ...
                        <asp:BoundField DataField="percent_score_sim3" ItemStyle-HorizontalAlign="Left" HeaderText="SIM3- %" Visible="false"
                                HeaderStyle-BackColor="#98272d" SortExpression="percent_score_sim3" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="left"></ItemStyle>
                                </asp:BoundField>
                                
                                <asp:BoundField DataField="edited_score_remarks_sim3" ItemStyle-HorizontalAlign="Left" HeaderText="SIM3- Comments" Visible="false"
                                HeaderStyle-BackColor="#98272d" SortExpression="edited_score_remarks_sim3" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="left"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="submitted_staff_sim3" ItemStyle-HorizontalAlign="Left" HeaderText="SIM3- Submitted By" Visible="false"
