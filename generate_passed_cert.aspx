<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="generate_passed_cert.aspx.cs" Inherits="generate_passed_cert" Title="Untitled Page" %>

<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    <title>Passed_students_Generatecerti-BCLS </title>
                ...
                <tr>
                    <td class="styleCC" align="center" bgcolor="White">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            ForeColor="#333333" CellSpacing="2" Width="859px" Caption='Passed Students For Approval'
                               ...
                               <%-- <asp:TemplateField ShowHeader="true" HeaderText="Certificates" HeaderStyle-BackColor="#98272d"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lb_certificate" runat="server" ForeColor="Black" CausesValidation="false"
                                            CommandName="certificates" Text="Certificate" Visible="false"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="true" HeaderText="Send Mail" HeaderStyle-BackColor="#98272d"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lb_mail" runat="server" ForeColor="Black" CausesValidation="false"
                                            Text="Mail" CommandName="mail_certificate" Visible="false" CommandArgument='<%#Eval("student_id")%>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            </Columns>
                        ...
                        <br />
                        <br />
                        <asp:ImageButton ID="bt_approve" runat="server"  Width="145px" Height="48px" Style="margin-top: 20px"
                         ImageUrl="~/images/BtnApprove2.png" OnClick="Button4_Click" />
                        <br />
                    </td>
                </tr>
            </table>
