<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V1_1_Simulation2_G3.aspx.cs" Inherits="NSL_V1_1_Simulation2_G3" %>
...
<body bgcolor="White">
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="Consolidation Skills 2 (Case scenario 3)"
 ...
 Brief Summary: <br /> Mr. Mohd Ali, 70 years old nursing home resident with medical history of HIV positive and difficulty in swallowing (with honey consistency fluid) was admitted due to urine tract infection, an indwelling catheter insitu. 
<br /><br />Group tasks:
...
<br />Nurse 4: Prepare 150 ml of honey consistency thickened fluid for patient.
<br />Nurse 5: Collect the urine FEME & CS from the patient with urinary catheter.
			...
			<%---------------------------------------------------------------------------------------------------------------------------------------------%>
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Fluid had been thickened, converted to nectar consistency</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					<td>19</td>
					<td align="left" rowspan="4">Collect urine for FEME & C/S from urinary catheter.
					</td>
					<td align="left">Clamp the urinary catheter at the proximal site of the urinary bag tubing just below the rubber sampling port for 30 min & Swab the sampling port with alcohol swab and allow the alcohol to dry.
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Attach 21G needle to a 10ml syringe and remove the needle cover with one hand technique. Insert the needle at 30 to 45 degree and withdraw 10 ml the urine steadily after that to inject 5ml of urine into each specimen bottle.
					</td>
					<td  colspan="5" align="center" >
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Clean the urine port with alcohol swab and unclamp the urine catheter after collecting the urine specimen.
					</td>
					<td  colspan="5" align="center" >
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Dispatch the urine specimen bottles in the biohazard bag with request form after labelling with correct patient’s name and ID number.
					</td>
					<td  colspan="5" align="center" >
