<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_1_Simulation1_G1.aspx.cs" Inherits="NSL_V2_1_Simulation1_G1" %>
 ...
 <%-- ---------------------------------------------------------------------------------------------%>
              ...
              <tr>
                <td align="left" colspan="11" class="styleCC">
                    Brief Summary:
                    <br /> <br />
               Mdm Lee Ho Yin a 76-year-old female was admitted with chief complains of indigestion and epigastric pain relieved by taking antacids. She
complained of rapid weight loss and lethargy. Patient has past medical history of chronic gastritis and pernicious anaemia. She has no known drug
allergies.  
  <br />  <br />A partial gastrectomy was performed two days ago to remove the cancerous lesion in the stomach. Post-operative instructions:
   <br /> <br />a) NBM and IV drip
   <br />b) NGT to intermittent suctioning.
   <br />c) Redivac drain to active suction
   <br />d) STO 14nd POD
   <br />e) Medications as ordered
    <br /><br />She exhibits signs of depression due to her recent diagnosis. 
	 <br />She is single and lives alone.
                </td>
            </tr>
             <tr bgcolor="#98272D" >
           ...
           <tr bgcolor="#98272D">
            ...
            >
                ...
                <td rowspan="4"  class="font-italic">
                    Patient is alert, orientated and anxious when talking to students; complains 
                    pain (6/10) at incision site. Inform students that patient looks pale.</td>
            </tr>
             ...
             <%-- ------------------------------------------------------------------------------- --%>                
                ...
                <td rowspan="4" class="font-italic">
                    TSO:<br />
Continue with parameters as state 1. 
                    <br /><br />
                    **Accord &quot;0&quot; mark if student:
                    <br />
                    -did not assess the vital signs
                    <br />
                    -did not re-evaluate the vital signs as necessary.<br />
                    Did not ask for pain score - 
                    6/10.</td>
            </tr>
           ...
           <%-- -----------------------------------------------------------------------
            ...
            <tr>
                <td>
                    10</td>
                <td align="left"  >
                                        Display effective and efficient respond and communication among team members <span lang="EN-US" style="font-size:12.0pt;line-height:
107%;font-family:&quot;Times New Roman&quot;,serif;mso-fareast-font-family:&quot;Times New Roman&quot;;
mso-ansi-language:EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA">and/or doctor </span>&nbsp;(roles specific).</td>
                <td align="left">
                    **Inform doctor the abnormal findings including pain score (6/10) using SBAR 
                    (situation, background, assessment &amp; recommendation).</td>
                <td  colspan="5" align="center" >
                    <b >
            ...
            >
                ...
                <td>
                    TSO: Instruct student to serve pain medications as per IMR.</td>
            </tr>                
            <%--   ------------------------------------------------------------------  --%>
                ...
                <td align="left" rowspan="6" >
                    Perform physical assessment on patient</td>
                <td align="left">
...
<br/>Breath sound = clear
<br/>Bowel sound = absent
<br/>Slight blood stained at wound dressing area. Moderate amount of drainage in the redivac drain. Verbalise no pain over the IV cannula insertion site.
<br/><br/>
Lecturer: <br/>
<br/>Deduct marks to "1 or 2" marks for this category if students: 
<br/>-did not conduct the required physical assessment (bowel sound)
        ...
        <tr>   
                ...
                <td >
                    13</td>
                <td align="left" >
                    Inspection of the surgical wound site and drainage bottle.</td>
                <td  colspan="5" align="center"  >
           ...
           <%-- -----------------------------------------------------------------------
            --%>
                ...
                <td >
                    14</td>
                <td align="left" >
                  Inspection of IV cannula site with IV Dextrose 5%/Sodium Chloride 0.9% connected. Assess using  POET (pain, oedema, erythema &amp; temperature) and check insertion date of cannula</td>
                <td  colspan="5" align="center"  >
                ...
                <td >
                    15</td>
                <td align="left" >
                    Assess the urine bag is placed below the bladder level and bag is not more than 
                    ¾ full.</td>
                <td  colspan="5" align="center"  >
                ...
                <td >
                    16</td>
                <td align="left" >
                   Assess the lower limbs for oedema.( Cue : DVT)</td>
                <td  colspan="5" align="center"  >
				...
				TSO:<br/> To verbalise pain over right calf limbs. Warmth to touch and Redness seen. Pain score (6/10).
<br/>Depth of oedema = 1+ (2mm)
             ...
             <tr>
                <td>
                    17</td>
                <td align="left" >
                    Display effective and efficient respond and communication with doctor.</td>
                <td align="left">
                    Inform doctor of abnormal findings using SBAR (situation, background, assessment 
                    &amp; recommendation). 
					
				<br/>	*Recommends anti- embolic stockings.
                ...
                <td>
                   TSO verbalise as doctor :<br/>
a) To start IV Heparin ( ask RN to
prepare)<br/>
b) Agrees with the anti-embolic
stockings. (Lecturer to award marks as long as attempted to wear TED stockings)</td>
            </tr>                
          <%--  ----------------------------------------------------------------------%>
             ...
             <tr>
                <td>
                    18</td>
                <td align="left" rowspan="4" >
                   Serve medications IM Morphine 10mg 6hrly/prn,IM Prochlorperazine 12.5mg 6hrly/prn)</td>
                <td align="left">
                ...
                <td rowspan="4" class="font-italic">
                    ...
                    **Accord &quot;0&quot; mark if student:<br />
                    -did not assess perform 5 rights and 3 checks appropriately.
                    <br />
                    - did not identify patient by name and IC number.<br />
                    <br />
                    TSO : To make the patient vomit if IM Prochlorperazine is missed out
                 </td>
            </tr>                
             ...
             <tr>
                <td>
                    19</td>
                <td align="left">
                    Explain the indications, side effects and patient’s education advice for both 
                    drugs (advise on fall precaution for Morphine).</td>
                <td  colspan="5" align="center" >
        ...
        --%>   
          ...
          <tr>
                ...
                <td align="left" rowspan="2" >
                    Evaluate patient&#39;s condition 30 minutes after administration of medications.</td>
                <td align="left">
                    Re- assess pain score.</td>
                <td  colspan="5" align="center" >
                ...
                <td >
                    23</td>
                <td align="left" >
                    Reinforce on fall precaution measures.</td>
                <td  colspan="5" align="center"  >
         ...
         <%-- ------------------------------------------------------------------------------- --%>                
          ...
          <%--   ------------------------------------------------------------------  --%>
                ...
                <td class="font-italic" rowspan="3">
                    Lecturer:
                    <br />
                    Deduct marks to &quot;1 or 2&quot; marks for this category if students: -did not ensure 
                    patient’s safety</td>
            </tr>                
                     <tr>
                <td>
