<%@ Page Language="C#" MasterPageFile="~/NSL_MasterPage.master" AutoEventWireup="true" CodeFile="NSL_All_Groups.aspx.cs" Inherits="NSL_All_Groups" Title="Untitled Page" %>

<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    <title>All Groups-NSL V3.1</title>
...
>
                 ...
                 <asp:BoundField DataField="percent_score_sim1" ItemStyle-HorizontalAlign="Left" HeaderText="ACS- %"
                            ...
                            <asp:BoundField DataField="edited_score_remarks_sim1" ItemStyle-HorizontalAlign="Left" HeaderText="ACS- Comments"
                                HeaderStyle-BackColor="#98272d" SortExpression="edited_score_remarks_sim1" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="left"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="submitted_staff_sim1" ItemStyle-HorizontalAlign="Left" HeaderText="ACS- Submitted By"
                 ...
                 <asp:BoundField DataField="percent_score_sim2" ItemStyle-HorizontalAlign="Left" HeaderText="BT- %"
                            ...
                            <asp:BoundField DataField="edited_score_remarks_sim2" ItemStyle-HorizontalAlign="Left" HeaderText="BT- Comments"
                                HeaderStyle-BackColor="#98272d" SortExpression="edited_score_remarks_sim2" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="left"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="submitted_staff_sim2" ItemStyle-HorizontalAlign="Left" HeaderText="BT- Submitted By"
                        ...
                        <asp:BoundField DataField="percent_score_sim3" ItemStyle-HorizontalAlign="Left" HeaderText="TC- %"
                                ...
                                <asp:BoundField DataField="edited_score_remarks_sim3" ItemStyle-HorizontalAlign="Left" HeaderText="TC- Comments"
                                HeaderStyle-BackColor="#98272d" SortExpression="edited_score_remarks_sim3" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="left"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="submitted_staff_sim3" ItemStyle-HorizontalAlign="Left" HeaderText="TC- Submitted By"
