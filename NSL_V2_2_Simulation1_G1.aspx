<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_2_Simulation1_G1.aspx.cs" Inherits="NSL_V2_2_Simulation1_G1" %>
 ...
 function  show_score()
{
 ...
 if (rb != null)
    ...
    actual_score_float = (parseInt(total_score) / 136) * (5 / 100) * 100;//Total/136 X 5% 
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
           ...
           <tr bgcolor="#98272D">
                <td  align="left"  colspan="11" style="border: 1px solid white;" class="style2">
                    <asp:Label ID="Label5" runat="server" Text="Immediate nursing interventions on admission to the Antenatal ward" Font-Bold="True" Font-Size="Large"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
            </tr>
           ...
           <tr bgcolor="#98272D">
                ...
                <td align="left" >
                   Check doctor's order from case notes and clinical chart
</td>
                <td align="left">
                   Reviews doctor orders, all nursing documentation and charts 
 </td>
            ...
            >
                ...
                <td class="font-italic">
                    ...
                    TSO: <br/> Activate state 1:<br/> 

					RR-24b/min, HR-106b/min, BP-152/90mmHg, SpO2-98%, Temp-37.2°C, Urine output-30mLs on admission, Urine protein on dipstick 2+
					<br/> <br/> 
					Lecturer:<br/> 
					- To insert the case notes with doctor's orders.
</td>
            </tr>
...
- did not perform hand hygiene.
        ...
        <%-- ------------------------------------------------------------------------------- --%>   
                ...
                <td class="style7" >
                    3</td>
                <td align="left" class="style7" rowspan="4">
                ...
                <td class="style8" rowspan="4" valign="top">
					...
					Patient is awake, alert and oriented to person, place and time when talking to students. 
					<br/>General oedema on the face, abdomen, hands and legs seen.
                ...
                <td align="left">
                   Check patient name and ID (checking ID band against charts)</td>
                <td  colspan="5" align="center" >
                    <b>
             ...
             <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td>
                    5</td>
                <td align="left">
                    Obtain objective and  subjective data from patient/relatives to plan nursing interventions</td>
                <td  colspan="5" align="center" >
                    <b>
                ...
                <td align="left" rowspan="4">
                   Obtain patient's initial haemodynamic status timely and correctly(Within 5 minutes of admission)</td>
					 <td align="left">
                ...
                <td>
				  ...
				  <td class="style8" rowspan="4">
					...
					TSO:<br/>
					Activate state 1:  <br/>
					RR-24b/min, HR-106b/min, BP-152/90mmHg, SpO2-98%, Temp-37.2°C, Urine protein on dipstick 2+
					<br/><br/>

					Lecturer:<br/>
					** Accord "0" mark if student: <br/>
					- did not assess the vital signs within 5 minutes of admission.<br/>
					- did not check urine for proteinuria.<br/>
					- did not check the pain score (for uterine contraction or frontal headache).<br/>
					- did not re-evaluate the vital signs every 15 minutes.<br/>
					- did not inform the doctor when BP 152/90mmHg.<br/>
			 ...
			 <%-- ------------------------------------------------------------------------------- --%> 	  
                ...
                <td>
                    9</td>
                <td align="left" >
                   Pain assessment: Use of OLDCART, pain score (for uterine contraction or frontal headache)</td>
			 ...
			 <tr>
                <td>
                    10</td>
                <td align="left" >
                 ** Re-evaluate vital signs every 15 minutes</td>
             ...
             <%-- ------------------------------------------------------------------------------- --%>   
                ...
                <td>
                    11</td>
                <td align="left" >
                    Perform  physical assessment from head to toe
				</td>
                <td align="left">
                    Check hourly pupils size (3mm and reactive to light), oedema(pitting oedma - 4+), deep tendon reflexes - 3+  and fetal heart rate 
					<br/>- to inform doctor if deep tendon reflexes 4+ or absent</td>
                <td  colspan="5" align="center" >
                    <b>
                ...
                <td class="font-italic">
                    ...
                    Lecturer: <br/> 
** Accord "0" mark if student:  <br/>
- did not check the pupils size (3mm and reactive to lights), oedema (pitting oedema - 4+) and deep tendon reflexes 3+ (slightly hyperactive) and fetal heart rate - 130b/min.  <br/> 
- did not inform doctor when deep tendon reflexes 4+ (indicates hyperactive with intermittent or transient clonus) or absent </td>
            </tr>  
				   <%-- ------------------------------------------------------------------------------- --%>   
                ...
                <td>
                    12</td>
                <td align="left">
                   Call doctor to inform patient's parameters</td>
				   <td align="left">
                ...
                <td>
                    ...
                    <asp:TextBox ID="remarks12" runat="server" class="RemarksTextarea" 
                        Font-Names="Arial" Text="" TextMode="MultiLine"></asp:TextBox>
							...
							Lecturer:<br/>
** Accord "0" mark if student:<br/>
- Inefficient update of the parameter reading.
                  </td>
            </tr>  
			  <%-- ------------------------------------------------------------------------------- --%>   
                ...
                <td align="left">
				 ...
				 <td align="left">
                   Check doctor's latest orders from case notes
				</td>
                <td  colspan="5" align="center" >
                    <b>
                ...
                <td align="left" rowspan="5">
                    Administer  sublingual Nifedipine 10mg stat</td>
					  <td align="left">
                ...
                <td>
                    ...
                    <asp:TextBox ID="remarks14" runat="server" class="RemarksTextarea" 
                        Font-Names="Arial" Text="" TextMode="MultiLine"></asp:TextBox>
							...
							Lecturer:<br/>
** Accord "0" mark if student:<br/>
- did not observe 5 rights prior to serving of Nifedipine.<br/>
- did not obtain allergy history.<br/>
- did not observe for side effects of Nifedipine (hypotension, dyspnoea).
							</td>
            </tr>  
				  <%-- ------------------------------------------------------------------------------- --%>   
        <tr>
...
<%-- ------------------------------------------------------------------------------- --%> 
 <tr>
                <td>
                    18</td>
                <td align="left" >
                   ** Observe for side effects of sublingual Nifidepine </td>
...
<%-- ------------------------------------------------------------------------------- --%> 
 ...
 <tr>
                ...
                <td align="left" rowspan="2">
                   Re-evaluate patient's hemodynamic status after administer sublingual Nifedipine</td>
					  <td align="left">
                    Re-evaluate patient's parameters every 15 mins including pain score (for frontal headache and uterine contraction</td>
                <td  colspan="5" align="center" >
                    <b>
                ...
                <td>
                    ...
                    <asp:TextBox ID="remarks19" runat="server" class="RemarksTextarea" 
                        Font-Names="Arial" Text="" TextMode="MultiLine"></asp:TextBox>
							...
							TSO:<br/>
Activate state 2: <br/> 
RR-28b/min, HR-124b/min, BP-165/98mmHg, SpO2-98%, Temp-37.5°C, Urine output-15mLs/hr
							</td>
            </tr>
   ...
   <%-- ------------------------------------------------------------------------------- --%>   
			...
			<tr>
                ...
                <td align="left" rowspan="3">
                    Administer IV 5% Dextrose at 80mLs/hr</td>
                <td align="left">
...
- did not observe for signs of  fluid overload (dyspneoa, breathlessness, cyanosis). </td>
            </tr>
 ...
 <tr>
                <td>
                    23</td>
                <td align="left">
                   Ensure administer the correct amount of IV fluids </td>
                <td  colspan="5" align="center" >
                    <b>
    ...
    <tr>
                <td>
                    24</td>
                <td align="left">
                   Continuous cardiotocograph monitoring (CTG)</td>
					 <td align="left">
                   To monitor fetal well being and uterine contraction<br/>
- advise patient to lie on the left lateral position  </td>
                <td  colspan="5" align="center" >
                    <b>
                ...
                <td>
                    ...
                    <asp:TextBox ID="remarks24" runat="server" class="RemarksTextarea" 
                        Font-Names="Arial" Text="" TextMode="MultiLine"></asp:TextBox>
							  ...
							  Lecturer:<br/>
** Accord "0" mark if student: <br/>
- did not know how to interpret the CTG graph and identify abnormalities (late deceleration). <br/>
- did not inform doctor if  CTG shows late deceleration in the fetal heart rate.
							   </td>
            </tr>
    ...
    <tr>
                <td>
                    25</td>
                <td align="left" rowspan="5">
                    Obtain and interpret blood investigations</td>
					  <td align="left">
                    # Hct stat and daily</td>
                <td  colspan="5" align="center" >
                    <b>
...
After the students despatched the blood and urine investigation, Lecturer is to inform students when the results are back for them to interpret.
<br/><br/>
- Lab results:<br/>
...
Lecturer:<br/>
** Accord "0" mark if student:<br/>
- did not notify the doctor of the lab results.<br/>
							   </td>
            </tr>
            <%-- ------------------------------------------------------------------------------- --%> 
     ...
     <tr>
                <td>
                    26</td>
                <td align="left">
                    # Liver function tests stat and daily:<br/>
- To exclude liver failure </td>
                <td  colspan="5" align="center" >
                    <b>
    ...
    <tr>
                <td>
                    27</td>
                <td align="left" >
                    # Renal plane 1 & 2:U/E/Cr/Uric acid stat and daily<br/>
					- To check renal function </td>
    ...
    <%-- ------------------------------------------------------------------------------- --%> 
      <tr>
                <td>
                    28</td>
                <td align="left" >
                   # Platelets count stat and daily<br/>
To check the bleeding and clotting time</td>
    ...
    <%-- ------------------------------------------------------------------------------- --%> 
     <tr>
                <td>
                    29</td>
                <td align="left" >
                 Urine FEME/Culture<br/>
- check the proteinuria<br/>
- exclude infection</td><br/>
    ...
    <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td>
                    30</td>
                <td align="left" >
                 Monitor strict intake and output</td>
                <td align="left">
                  To monitor hourly urine output (normal urine output should be 30mLs/hour)<br/>
- observe for fluid overload</td>
                <td  colspan="5" align="center" >
                    <b>
...
- did not inform doctor if urine output < 30mLs/hour.</td>
            </tr>
   ...
   <%-- ------------------------------------------------------------------------------- --%> 
     <tr>
                <td>
                    31</td>
                <td align="left" >
                   Provide proper and timely documentation of procedure in report</td>
                <td align="left">
...
4. IMR is signed/E-IMR is marked as done</td>
    ...
    <tr>
                ...
                <td align="left">
                 Nursing intervention performed resulted in desired outcome
...
Deduct marks to "1" or "2" marks for this category if students:<br/>
- did not inform the doctor immediately when the urine output is < 30mLs/hr, BP is > 165/98, respiration < 12b/min, HR > 120b/min, deep tendon reflexes is 4+ or absent, fetal heart rate showed with late deceleration seen on CTG.
                  </td>
            </tr>
   ...
   <%-- ------------------------------------------------------------------------------- --%>   
       ...
       CausesValidation="false" 
            ...
            <tr>
              ...
              <br/>  <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Bold="true" Text="Total/136 X 5% "></asp:Label>
                </td>
                <td colspan="8" align="left">
                    &nbsp;</td>
            </tr>
