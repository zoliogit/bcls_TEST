<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_1_Simulation3_G3.aspx.cs" Inherits="NSL_V2_1_Simulation3_G3" %>
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="SIM3-OPTION 3"
            ...
            >
             ...
             <%-- ------------------------------------------------------------------------------- --%>                
                ...
                <td rowspan="6" class="font-italic">
                                        Lecturer: </br>
                                        **Accord "0" mark if student did not perform any steps. TSO:
Keep in  State 2 (Condition Deteoriorates)
RR-28b/min, HR-150b/min, BP-86/50mmHg, SpO2-89%, Temp-38.8 deg Celcius</td>
            </tr>
           ...
           <%-- -----------------------------------------------------------------------
            --%>
             ...
             <tr>
                ...
                <td rowspan="8" class="font-italic">
                    Lecturer: </br> Inform the s/s of adverse reaction to students.&nbsp;  </br> </br>TSO: </br> Complains of feeling warm, headache and itchiness on the torso. To inform student that there are red spots on arms and legs.</td>
            </tr>                
          ...
          <%--  ----------------------------------------------------------------------%>
             ...
             <tr>
                <td>
                    14</td>
                <td align="left" rowspan="6" >
                    Perform nursing intervention on adverse reaction.</td>
                <td align="left">
                    Stop blood transfusion STAT.</td>
                <td  colspan="5" align="center" >
                ...
                <td rowspan="6" class="font-italic">
                    TSO:</br> Activate Recovery state (Only if students have perform all required nursing 
                    intervention as listed): </br>RR- 18b/min, HR- 88b/min, BP- 110/62 mmHg, SpO2- 96%, 
                    Temp- 37 deg Celcius. Pain Score: 3</td>
            </tr>                
             ...
             <tr>
                <td>
                    15</td>
                <td align="left">
                    Remove the blood product and its administration set.</td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                <td>
                    16</td>
                <td align="left">
                    (Verbalise) To send the incomplete blood product including the running set to 
                    the blood bank.</td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                <td>
                    17</td>
                <td align="left">
                    Establish airway and administer high flow oxygen.</td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                <td>
                    18</td>
                <td align="left">
                    IV N/S 0.9% challenge using a new infusion set</td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                ...
                <td align="left" class="style15">
                    Verbalise to administer antihistamines if ordered by doctor.</td>
             ...
             <tr>
                ...
                <td align="left" rowspan="2" >
                    Follow up on blood &amp; urine test.</td>
                <td align="left">
                    FBC, Renal Panel, ABG </td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                <td>
                    21</td>
                <td align="left">
                    Blood and Urine samples to detect antiobodies.</td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                <td class="style12">
                    23</td>
                <td align="left" class="style12">
                    Update the about the change in condition and interventions done and required. </td>
                <td  colspan="5" align="center" class="style12" >
             ...
             <tr>
                <td>
                    24</td>
                <td align="left" >
                    Continuously monitor patient&#39;s parameters during and after the treatment.</td>
                <td align="left">
                    1. Monitor parameters closely </br> 2. Monitor I/O strictly</br> 3. Conscious level</td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                ...
                <td align="left" class="style13">
                    Ensure all aspects in the blood card are filled up correctly. Verbalise that the 
                    blood unit, blood set with blood investigations will be despatched to the lab 
                    immediately. </td>
             ...
             <tr>
                <td>
                    26</td>
                <td align="left" >
                    Develop a teaching plan to educate patient on prevention of future expisode of 
                    bleeding GIT</td>
                <td align="left">
                    1. Do not take medications without consulting a doctor </br> 2. Recognise the signs 
                    and symptoms of bleeding GIT </br> 3. Complete course of medications prescribed (PPI) 
                   </br> 4. Emphasise on follow up appointment after discharge</td>
                <td  colspan="5" align="center" >
                ...
                <td class="font-italic">
                    Accept any other salient points on patient education. </td>
            </tr>                
