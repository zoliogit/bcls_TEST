<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_Simulation2_Opt2.aspx.cs" Inherits="NSL_Simulation2_Opt2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Blood Transfusion-Opt2</title>
            ...
            <tr>
                <td bgcolor="#F7F6F3" class="styleCC">
                  ...
                  <asp:Label ID="Label161" runat="server" Font-Bold="False" Font-Size="X-Large" ForeColor="Black"
                        Text="BLOOD TRANSFUSION - OPTION 2" Font-Names="Arial"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
                ...
                <td align="center"  style="border: 1px solid white;" class="style47" >
                  <b>
                  ...
                  <td align="center"  style="border: 1px solid white;" class="style48" >
                   <b>
                ...
                <td rowspan="2" align="center" style="border: 1px solid white;width:150px;" >
                    <b>
...
<tr><td>20</td> <td>Wear gloves</td> <td align="center" colspan="5"><b>
             ...
             <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="PART B - OPTION 2 (PULMONARY EDEMA)"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
 ...
 <%-- ---------------------------------------------------------------------------------------------%>
            ...
            <tr>
                <td align="left" colspan="10" class="styleCC" bgcolor="#ffff66">
                    Cue: Activate this state if students manage to administer the blood within the 
                    first 7 mins, but start the blood infusion rate too fast (&gt;20 drops/min). </td>
                    <td bgcolor="#ffff66" class="font-italic">
                        TSO:                         <br />
                        Activate State 3 (Pulmonary edema):
                        <br />
                        RR- 30b/min, HR- 130b/min, BP- 82/52 mmHg, SpO2- 88%,
                        <br />
                        Temp- 37 deg Celcius, ECG- ST.</td>
            </tr>
			  <%------------------------------------PART B OPTION 2-QUEST NO :34-------------------------------------------------------------%>
                          <tr>
                <td rowspan="8" >
                    34</td>
                <td align="left" class="style45" rowspan="8">
                    Recognise s/s of pulmonary edema timely</td>
                 <td >
               <%-- <table border="1" bordercolor="#98272d" style="border-style:hidden;width:100%;height:100%; border-collapse: collapse;">
                <tr>
                <td align="left" >
                    Tachypnea/Dyspnea/Orthopnea/severe hypoxia</td>
               </tr>
               <tr>
                 <td align="left" class="style25">
                     Restlessness/Anxiety</td></tr>
               <tr>
                 <td align="left" class="style25">
                     Productive cough&nbsp; frothy, pink sputum</td></tr>
                <tr>
                 <td align="left" class="style25">
                     Crackles/wheezes/Stridor</td></tr>
                <tr>
                 <td align="left" class="style25">
                     Tachycardia</td></tr>
                  <tr>
                 ...
                 <tr>
                 <td align="left" class="style25">
                     Ventricular gallop</td></tr>
                 <tr>
                 <td align="left" class="style25">
                     Cyanosis/Cool/Clammy skin</td></tr>
                ...
                <td colspan="5" align="center" rowspan="8">
                   <b >
                      <asp:RadioButtonList RepeatColumns="5" ID="RadioButtonList34" class="style_radio" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table"  Width="100%"   >
                            <asp:ListItem Text=""  Value="0"></asp:ListItem>
                            <asp:ListItem Text=""  Value="1"></asp:ListItem>
                            <asp:ListItem Text=""  Value="2"></asp:ListItem>
            ...
            >
                ...
                <td align="center" class="style49" rowspan="8">
                    4</td>
                <td rowspan="8"   >
                ...
                <td  class="font-italic" rowspan="8" >
                    Lecturer: Inform the s/s of pulmonary edema to students.
                    <br />
                    <br />
                    TSO: Set manikin: Breath sounds- crackles/wheeze, heart sound- ventricular 
                    gallop. Restless and anxiety. Patient is coughing.</td>
           
            </tr> 
            
                          <tr>
                 <td >
                     Restlessness/Anxiety</td>
           
            </tr> 
            
                          <tr>
                 <td >
                     Productive cough of frothy, pink sputum</td>
           
            </tr> 
            
                          <tr>
                 <td >
                     Crackles/wheezes/Stridor</td>
                 ...
                 <td >
                     Hypotension</td>
                          ...
                          <tr>
                 <td >
                     Ventricular gallop</td>
           
            </tr> 
            
                          <tr>
                 <td >
                     Cyanosis/Cool/Clammy skin</td>
           
            </tr> 
            
              <%------------------------------------PART B OPTION 2-QUEST NO :35-------------------------------------------------------------%>
             <tr> 
            <td  >35</td> 
             <td rowspan="6" class="style45" >Perform nursing intervention for pulmonary edema 
                 correctly</td> 
            <td >Slow down the blood flow rate to below 20drops/min.</td> 
            <td colspan="5" align="center" > <b >
                       <asp:RadioButtonList RepeatColumns="5" ID="RadioButtonList35" class="style_radio" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table"  Width="100%"   >
                            <asp:ListItem Text=""  Value="0"></asp:ListItem>
                            <asp:ListItem Text=""  Value="1"></asp:ListItem>
                            <asp:ListItem Text=""  Value="2"></asp:ListItem>
            ...
            runat="server"
            ControlToValidate="RadioButtonList35"
            ErrorMessage="Select One!"
            ForeColor="Red"
            >
        </asp:RequiredFieldValidator></td>
            <td class="style53" align="center" >4</td>
              <td   align="center" >
...
Activate Recovery state (Only if students have performed all required nursing intervention as listed):</br>
RR- 21b/min, HR- 90b/min, BP- 100/60 mmHg, SpO2- 98%, Temp- 37 deg Celcius.</br></br>

Inform student to check the result from the system if ordered and done.</br></br>

**To accord "0" marks if any steps missing.</br>
			   ...
			   <%------------------------------------PART B OPTION 2-QUEST NO :36-------------------------------------------------------------%>
             <tr><td >36</td> <td >Ensure airway is patent and administer 100% oxygen (by NRM)
</td> <td align="center" colspan="5"><b >
                        <asp:RadioButtonList RepeatColumns="5" ID="RadioButtonList36" class="style_radio" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table"  Width="100%"   >
                            <asp:ListItem Text=""  Value="0"></asp:ListItem>
                            <asp:ListItem Text=""  Value="1"></asp:ListItem>
                            <asp:ListItem Text=""  Value="2"></asp:ListItem>
            ...
            runat="server"
            ControlToValidate="RadioButtonList36"
            ErrorMessage="Select One!"
            ForeColor="Red"
            >
        </asp:RequiredFieldValidator></td> 
            <td class="style53" align="center" >4</td>
              <td   align="center" >
				  ...
				  <%------------------------------------PART B OPTION 2-QUEST NO :37-------------------------------------------------------------%>
           <tr><td >37</td> <td >Assess heart sound for murmurs/ventricular gallop</td> <td align="center" colspan="5"><b >
          ...
          <%------------------------------------PART B OPTION 2-QUEST NO :38-------------------------------------------------------------%>
            <tr><td >38</td> <td >Perform and review CXR.</td> <td align="center" colspan="5">
                    <b>
                     <asp:RadioButtonList RepeatColumns="5" ID="RadioButtonList38" class="style_radio" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table"  Width="100%"   >
                            <asp:ListItem Text=""  Value="0"></asp:ListItem>
                            <asp:ListItem Text=""  Value="1"></asp:ListItem>
                            <asp:ListItem Text=""  Value="2"></asp:ListItem>
            ...
            runat="server"
            ControlToValidate="RadioButtonList38"
            ErrorMessage="Select One!"
            ForeColor="Red"
            >
        </asp:RequiredFieldValidator>
  ...
  <%------------------------------------PART B OPTION 2-QUEST NO :39-------------------------------------------------------------%>
            <tr><td >39</td> <td >Take ABG</td> <td align="center" colspan="5"><b >
                       <asp:RadioButtonList RepeatColumns="5" ID="RadioButtonList39" class="style_radio" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table"  Width="100%"   >
                            <asp:ListItem Text=""  Value="0"></asp:ListItem>
                            <asp:ListItem Text=""  Value="1"></asp:ListItem>
                            <asp:ListItem Text=""  Value="2"></asp:ListItem>
            ...
            runat="server"
            ControlToValidate="RadioButtonList39"
            ErrorMessage="Select One!"
            ForeColor="Red"
            >
        </asp:RequiredFieldValidator></td> 
            <td class="style53" align="center" >4</td>
              <td   align="center" >
                    ...
                    <asp:TextBox ID="remarks39" runat="server" class="RemarksTextarea" 
                        Font-Names="Arial" Text="" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr> 
            

  <%------------------------------------PART B OPTION 2-QUEST NO :40-------------------------------------------------------------%>
        <tr><td >40</td> <td >** Administer IV Furosemide 40 mg safely</br>
a) Verify correct patient (Scan barcode on wrist tag, to ask  patient and compare against IMR)</br>
b) Verify any allergies</br>
c) Verify correct drug (scan drug and compare against IMR)</br>
d)Administer IV Furosemide 40 mg bolus ( check correct amount: 4 ml)</br>

                   </td> <td align="center" colspan="5"><b >
                       <asp:RadioButtonList RepeatColumns="5" ID="RadioButtonList40" class="style_radio" runat="server" RepeatDirection="Horizontal"
                            RepeatLayout="Table"  Width="100%"   >
                            <asp:ListItem Text=""  Value="0"></asp:ListItem>
                            <asp:ListItem Text=""  Value="1"></asp:ListItem>
                            <asp:ListItem Text=""  Value="2"></asp:ListItem>
            ...
            runat="server"
            ControlToValidate="RadioButtonList40"
            ErrorMessage="Select One!"
            ForeColor="Red"
            >
        </asp:RequiredFieldValidator></td> 
            <td class="style53" align="center" >4</td>
              <td   align="center" >
                    ...
                    <asp:TextBox ID="remarks40" runat="server" class="RemarksTextarea" 
                        Font-Names="Arial" Text="" TextMode="MultiLine"></asp:TextBox>
                    </td>
                 ...
                 <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="style55" bgcolor="#98272D">
        ...
        <td class="style54" colspan="5" > <asp:Label ID="Label55" runat="server" Font-Names="Arial" Font-Bold="true" Text=" "></asp:Label> <asp:Label ID="Label56" runat="server" Font-Names="Arial" Font-Bold="true" Text=" "></asp:Label> <asp:Label ID="Label57" runat="server" Font-Names="Arial" Font-Bold="true" Text=" "></asp:Label> <asp:Label ID="Label58" runat="server" Font-Names="Arial" Font-Bold="true" Text=" "></asp:Label> <asp:Label ID="Label59" runat="server" Font-Names="Arial" Font-Bold="true" Text=" "></asp:Label></td>
          <td align="center" > <asp:Label ID="Label60" runat="server" Font-Names="Arial" Font-Bold="true" Text="172"></asp:Label></td>
           ...
           <td align="center" > <asp:Label ID="lb" runat="server" Font-Size="Medium" Font-Names="Arial" Font-Bold="true" Text="Part A+B+C"></asp:Label></td></tr>
                <tr>
              <td class="style42" > 
                  <asp:Label ID="Label62" runat="server" Font-Bold="true" Font-Names="Arial" 
                      Text="Actual Score upon 10%"></asp:Label>
                    </td>
             <td  align="left" >  <asp:Label ID="lb_actualscore" runat="server" Text="" 
                     Font-Bold="True" Font-Size="Large"
                            Font-Names="Arial"></asp:Label>
                        <asp:Button ID="btn_show_currentscore" autopostback="false" 
                     runat="server" Text="Update" Font-Bold="true"  OnClientClick="return show_score()" 
       CausesValidation="false" 
             />
                    </td>
        <td class="style54" colspan="8" > &nbsp;</td>
            </tr>
         <tr>
              <td class="style45" colspan="2" align="right">  
                    <asp:Label ID="Label163" runat="server" Font-Names="Arial" Font-Bold="true" 
                      Text=" Calculation: Actual Score = "></asp:Label><br />
                  <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Bold="true" Text="Total/172 X 10% "></asp:Label>
                </td>
