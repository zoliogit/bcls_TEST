<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_Simulation2_Opt1.aspx.cs" Inherits="NSL_Simulation2_Opt1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Blood Transfusion-Opt1</title>
            ...
            <tr>
                <td bgcolor="#F7F6F3" class="styleCC">
                  ...
                  <asp:Label ID="Label161" runat="server" Font-Bold="False" Font-Size="X-Large" ForeColor="Black"
                        Text="BLOOD TRANSFUSION - OPTION 1" Font-Names="Arial"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
                ...
                <td >
                 ...
                 <td class="font-italic" colspan="3" rowspan="6">
                    ...
                    **Accord "0" mark if student did not perform any of the steps. Able to explain to the patient why medications omitted.</br></br>
                    ...
                    TSO:</br>
                    I didn't take any of my morning medications before coming to the hospital.
					<br/>Do I need to take all of it?
...
<tr><td>20</td> <td>Wear gloves</td> <td align="center" colspan="5"><b>
             ...
             <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="PART B - OPTION 1 (HYPOVOLEMIC SHOCK)"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
 ...
 <%-- ---------------------------------------------------------------------------------------------%>
            ...
            <tr>
                <td align="left" colspan="10" class="styleCC" bgcolor="#4da6ff">
                    Cue: Activate this state if students fail to administer the blood within the 
                    first 7 minutes or running it too slow (&lt;20 drops/min). </td>
                    <td bgcolor="#4da6ff" class="font-italic">
                        TSO:                         <br />
                        Activate State 2 (hypovolemic shock):
                        <br />
                        RR- 30b/min, HR- 130b/min, BP- 82/52 mmHg, SpO2- 93%, Temp- 37 deg Celcius, 
                        ECG-ST</td>
            </tr>
			  ...
			  <%------------------------------------PART B-QUEST NO :27-------------------------------------------------------------%>
                ...
                <td align="left" class="style41" rowspan="9">
                    Recognise signs and symptoms (s/s) of hypovolemic shock timely</td>
                 <td>
              <%--  <table border="1" bordercolor="#98272d" style="border-style:hidden;width:100%; border-collapse: collapse;">
                <tr>
   ...
   Unconsciousness
               ...
               </table >--%>Hypotension</td>
                <td colspan="5" align="center" rowspan="9">
                    <b>
                ...
                <td align="center" class="style39" rowspan="9">
                    4
                </td>
                <td rowspan="9"  >
                ...
                <td  class="font-italic" rowspan="9">
                    Lecturer: Inform the s/s of hypovolemia to students.
                    <br />
                    <br />
                    TSO: Set manikin: Breath sounds- clear, heart sound- normal. Slow to respond and 
                    confuse.</td>
            ...
            <%------------------------------------PART B-QUEST NO :28-------------------------------------------------------------%>
             <tr> 
            <td >28</td> 
             <td rowspan="5" class="style41" >Perform nursing intervention for hypovolemic shock</td> 
            <td>Administer oxygen</td> 
            <td colspan="5" align="center" > <b>
            ...
            <td class="style36" align="center" >4</td>
              ...
              <td  class="" rowspan="5" align="center" >
                    &nbsp;</td>
             </tr>
			 <%------------------------------------PART B-QUEST NO :29-------------------------------------------------------------%>
             <tr><td>29</td> <td>Perform CLC</td> <td align="center" colspan="5"><b>
            ...
            <td class="style36" align="center" >4</td>
              <td  class="" align="center" >
				...
				<%------------------------------------PART B-QUEST NO :30-------------------------------------------------------------%>
             <tr><td>30</td> <td>Administer the blood immediately if it has not been started yet / 
                    increase the drip rate if it is running too slow.</td> 
                 <td align="center" 
                     colspan="5">
                        <b>
            ...
            <td class="style36" align="center" >4</td>
              <td  class="" align="center" >
				...
				<%------------------------------------PART B-QUEST NO :31-------------------------------------------------------------%>
           <tr><td>31</td> <td>Administer IV Normal saline fast drip or Gelofusine or Hartman's</td> 
               <td align="center" colspan="5">
                    <b>
        ...
        <%------------------------------------PART B-QUEST NO :32-------------------------------------------------------------%>
            <tr><td>32</td> <td>Verbalise: IV Dopamine if BP drops further.</td> 
                <td align="center" colspan="5">
                    <b>
            ...
            <tr>
                ...
                <td align="left">
                    Monitor parameters closely and&nbsp; I/O strictly
                </td>
                <td colspan="5" align="center">
                    <b>
                ...
                <td class="font-italic">
                    TSO: Activate Recovery state (Only if students have perform all required nursing 
                    intervention as listed above):
                    <br />
                    RR- 21b/min, HR- 90b/min, BP- 100/60 mmHg, SpO2- 98%, Temp- 37 deg Celcius.</td>
           ...
           <td align="center" > <asp:Label ID="lb" runat="server" Font-Size="Medium" Font-Names="Arial" Font-Bold="true" Text="Part A+B+C"></asp:Label></td></tr>
            ...
            <asp:Label ID="lb_actualscore" runat="server" Font-Size="Medium" Font-Names="Arial" 
                Font-Bold="true" Text=""></asp:Label>
                 <asp:Button ID="btn_show_currentscore" runat="server" autopostback="false" 
                     CausesValidation="false" Font-Bold="true" OnClientClick="return show_score()" 
                     Text="Update" />
                </td>
        <td class="" colspan="8" > &nbsp;</td>
         ...
         <tr>
              <td align="right" colspan="2" > 
                  ...
                  </br> <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Bold="true" Text="Total/172 X 10% "></asp:Label>
                </td>
