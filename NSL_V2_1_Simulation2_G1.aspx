<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_1_Simulation2_G1.aspx.cs" Inherits="NSL_V2_1_Simulation2_G1" %>
 ...
 function  show_score()
{
 ...
 if (rb != null)
    ...
    actual_score_float = (parseInt(total_score) / 136) * (10 / 100) * 100;//Total/136X 10% 
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="SIM1-OPTION 1"
           ...
           <%-- ------------------------------------------------------------------------------- --%> 
            ...
            >
                ...
                <td rowspan="3"  class="font-italic">
                    Patient is alert and orientated:<br/> TSO: <br/>
"My name is Lee Ho Yin, I am in the hospital because I vomitted and had blood in my poo. I am feeling very tired."
                ...
                <td rowspan="6" class="font-italic">
                  Lecturer:<br />
                    **Accord "0" mark if student did not perform any steps. <br />TSO:<br />
                    Activate State 1 (Admission to ward: Hypotensive)
                    RR-26b/min, HR-120b/min, BP-108/58mmHg, SpO2-94%, Temp-36.9 deg Celcius.
        ...
        <tr>   
                ...
                <td align="left" >
                   Assess pain using the pain scale.
				</td>
                ...
                <td align="left" >
                    Measure and document patient's vital signs correctly on hourly parameters chart.
		</td>
           ...
           <%-- -------------------------------------------------------------------------%>                      
            <tr>
                <td>
                    4</td>
                <td align="left"  >
                                        Recognise the abnormal vital signs 
                </td>
                <td align="left">
                   Apply critical thinking and explain the abnormal readings : Hypotension, tachycardia and decreased O2 saturation.
                </td>
                <td  colspan="5" align="center" >
                    <b >
            ...
            >
                ...
                <td>
                   Lecturer: <br />BP is low and PR & RR is increased: indicates significant blood loss. SpO2 is low as oxygen carrying capacity with blood loss.
</td>
            </tr>                
              ...
              <%--   ------------------------------------------------------------------  --%>
                ...
                <td align="left" rowspan="4" >
                    Assess for the need for oxygen therapy
				</td>
                <td align="left">
                    Prop patient to 30 degree angle. 
                ...
                <td rowspan="4" class="font-italic">
                    Lecturer: <br/>Check with student if humidication is necessary. Humidifier will be used if more than 4L is administered to prevent mucous membrance from drying (NSL Book 1, 4th ed, 2011).
					</td>
            </tr>
        <tr>   
                <td>
                    6</td>
                <td align="left">
                    Select correct device for administration: Nasal cannula.
				</td>
                <td  colspan="5" align="center" >
                ...
                <td >
                    7</td>
                <td align="left" >
                   Adjust flow to the correct level. 
				</td>
                <td  colspan="5" align="center"  >
                ...
                <td >
                    8</td>
                <td align="left" >
                    Apply the cannula correctly unto the patient. 
 ...
 <%--  ----------------------------------------------------------------------%>
               ...
               <tr>
                <td>
                    9</td>
                <td align="left" >
                    Check patient's blood investigations
				</td>
                <td align="left">
                    Able to check for Full Blood Count, Coagulation and Biochemistry blood results. 
				</td>
                <td  colspan="5" align="center" >
                    <b>
              ...
              <%--  ----------------------------------------------------------------------%>
               ...
               <tr>
                <td>
                    10</td>
                <td align="left" >
                    Interprete patient's blood investigations

				</td>
                <td align="left">
                    Able to retrieve significant findings:<br/>
					1) FBC: WBC 7.5, RBC: 3.9, Hb 7, Hct 21%, Platelets 200.<br/>
					2) Biochemistry: Na 138, K 4, CI 112, CO2 23, Urea 6, Creatinine 127, Glucose 7.<br/>
					3) Coagulation PT 18, PTT 90
                ...
                <td>
                    Refer case notes or EMR system for results: Allocate 1 mark for each type of blood result identified. 
				</td>
            </tr>
            <%--  ----------------------------------------------------------------------%>
               ...
               <tr>
                <td>
                    11</td>
                <td align="left" >
                    Observes the nature of vomittus, nasogastric drainage and stools


				</td>
                <td align="left">
                   Apply critical thinking and explain the abnormal findings.
                ...
                <td>
                    Lecturer: <br/>Coffee grounds vomitus indicates upper GI bleed, dark tarry stools indicates digested blood
            ...
            <tr>
                <td>
                    12</td>
                <td align="left" >
                    Check correct placement of NG tube.  

				</td>
                <td align="left">
                   Connects syringe and peforms aspiration as ordered.
                ...
                <td>
                    Lecturer:<br/> Aspiration is minimal as patient is on continuous drainage.
             ...
             <%--  ----------------------------------------------------------------------%>
               <tr>
                ...
                <td align="left" rowspan="5" >
                    Performs physical assessment : IAPP
				</td>
                <td align="left">
                  Apply critical thinking to explain why physical assessment should be done IAPP instead of IPPA. Perform physical assessment on the abdomen.
				</td>
                <td  colspan="5" align="center" >
                    <b>
                ...
                <td rowspan="5">
                     Lecturer:<br/> Auscultation is done after inspection as percussion and palpation can increase peristalsis giving false interpretation of bowel sounds (Nursing Skills Book 2, 8th ed, 2015).
			...
			<tr>
				 <td>14</td>
				 <td align="left">
				 Inspection : contour, symmetry, detect 5F + A1: Fat, foetus, fluid, flatus, faeces, abdominal mass tumour. 
			...
			<tr>
				 <td>15</td>
				 <td align="left">
				Auscultation: listen for active bowel sounds in the four quadrants. 
         	...
         	<tr>
				 <td>16</td>
				  <td align="left">
				Palpation: Perform light palpation in the four quadrants.
				...
				<tr>
				 <td>17</td>
				  <td align="left">
				Percussion: percuss lightly in the four quadrants, tympanic sound should be heard.
                ...
                <td>
                    18</td>
                <td align="left" >
                  Check doctor's order from progress notes & IMR.
			 ...
			 <tr>
                ...
                <td align="left">
              Ensure consent is valid for blood transfusion, with patient name, ID and signature, witness name, ID and signature, Dr's name, MCR no. & signature.
			...
			<tr>
				 ...
				 <td align="left">
				 Inspect site for signs of pain, oedema, erythema and increased temperature (POET).
			...
			<tr>
				 ...
				 <td align="left">
				Ensure availability of IV cannula size 19G or larger.
         	...
         	<tr>
				  ...
				  <td align="left">
				(Verbalise) Flush line to ensure patency of IV line.
             ...
             <tr>
                <td>
                    22</td>
                <td align="left" rowspan="4" >
                    Check doctor's order in IMR for adminstration of IV Hartmans.

				</td>
                <td align="left">
                 Prime IV tubing with solution ordered in IMR.
                ...
                <td rowspan="4">
                    Student should be able to show the workings and count the drops and run the infusion.
			...
			<tr>
				 <td>24</td>
				 <td align="left">
				Swab IV port with alcohol swab before connecting and secure with micropore.
         	...
         	<tr>
				 <td>25</td>
				  <td align="left">
				Calculate the flow rate using the formula and run the IV as scheduled.</td>
				 <td  colspan="5" align="center" >
                    <b>
         ...
         Monitor the vital signs at regular intervals.
                ...
                <td align="left">
     Apply critical thinking and monitor the vital signs to detect for change in condition. Update the hourly parameters chart. 
                ...
                <td>
                    TSO:<br/> Patient c/o nausea and pain. 
              ...
              <tr>
                <td>
                    27</td>
                <td align="left" >
          Recognise the need to inform doctor of status and request for blood product from lab.

				</td>
                <td align="left">
     Contact the doctor to update the about the blood results and change in condition if any. Contact the blood bank and request for blood product. 
                ...
                <td>
                    Lecturer: <br/>Doctor orders to monitor patient closely and administer IM anti emetics as ordered. Student to prepare correct analgesics and PPI in kidney dish for administration by Staff Nurse. 
           ...
           Prepare patient for endoscopy
                ...
                <td align="left">
      (Verbalise) Check consent has been taken for the procedure. Patient has been instructed to be on NBM.
            ...
            <tr>
                <td>
                    29</td>
                <td align="left" >
            Use the pre-op checklist to prepare patient for endoscopy
       ...
       Use the pre-op checklist to prepare patient for endoscopy
			 ...
			 <tr>
                <td>
                    30</td>
                <td align="left" >
            Provide proper and timely documentation of procedures in report.
...
3. Update intake and output chart<br/>
                ...
                <td>
                    32</td>
                <td align="left" >
             Display good team work, effort and leadership among team members.

				</td>
                <td align="left">
         1. Role is well defined.<br/>
2. All team members coordinated well.<br/>
3. Display good leadership and delegation skills.<br/>
             ...
             <tr>
                <td>
                    33</td>
                <td align="left" >
               Display critical thinking and holistic care to patient.
				</td>
                <td align="left">
          1. Able to rationalise on the treatment given.<br/>
		  2. Good evaluation of patient's condition.
            ...
            <tr>
                <td>
                    34</td>
                <td align="left" >
                 Display good reflective learning.


				</td>
                <td align="left">
           Able to identify strength, weakness and suggest improvement.
