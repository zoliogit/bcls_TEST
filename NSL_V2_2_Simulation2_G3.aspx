<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_2_Simulation2_G3.aspx.cs" Inherits="NSL_V2_2_Simulation2_G3" %>
 ...
 function  show_score()
{
 ...
 if (rb != null)
    ...
    actual_score_float = (parseInt(total_score) / 148) * (5 / 100) * 100;//Total/148 X 5% 
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="SIM2-OPTION 3"
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
           ...
           <tr bgcolor="#98272D">
             ...
             <%-- ------------------------------------------------------------------------------- --%> 
               ...
               <tr>
                ...
                <td align="left" class="style13" rowspan="3" >
            ...
            >
                ...
                <td class="style14" rowspan="3">
                    ...
                    Lecturer: - To insert the case notes with doctor&#39;s orders</td>
            </tr>
           ...
           <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td class="font-italic">
                    ...
                    Lecturer:<br/> ** Accord &quot;0&quot; mark if student:<br/>  - did not perform hand hygiene</td>
            </tr>
          ...
          <tr>
                <td class="style11">
                    5</td>
                <td align="left" class="style11" rowspan="4" >
                ...
                <td class="style12" rowspan="4">
                            ...
                            Patient is awake, alert and oriented to person, place and time when talking to 
                            students.
		 ...
		 <%-- ------------------------------------------------------------------------------- --%> 		
                ...
                <td class="style11">
                    7</td>
                <td align="left" class="style11">
                   Obtain subjective data from patient/relatives to plan nursing interventions for the shif</td>
                <td  colspan="5" align="center" class="style11" >
			 ...
			 <%-- ------------------------------------------------------------------------------- --%> 		
                ...
                <td class="style11">
                    9</td>
                <td align="left" class="style11" rowspan="4">
                  Obtain patient's initial haemodynamic status timely and correctly(After taking over nursing report)</td>
					   <td align="left" class="style11">
                ...
                <td >
                  ...
                  TSO:<br/>
Activate state 1:  <br/>
RR-16b/min, HR-88b/min, BP-128/56mmHg, SpO2-98%, Temp-36.5°C,  <br/>
Breath sounds-clear<br/>
Bowel sounds-hyperactive</td>
            </tr>
          	 <%-- ------------------------------------------------------------------------------- --%> 		
			 <tr>
                <td class="style11">
       ...
       <%-- ------------------------------------------------------------------------------- --%> 	        
			 <tr>
                ...
                <td align="left" class="style11">
                 Pain assessment: Use of OLDCART, pain score (mild pain at left calf)</td>
                <td  colspan="5" align="center" class="style11" >
			  ...
			  <tr>
                ...
                <td  colspan="5" align="center" class="style15" >
			  ...
			  <tr>
                <td class="style15">
                            13</td>
                <td align="left" class="style15" >
                          Patient is send down to ultrasound room for doppler of the legs</td>
                <td align="left" class="style15">
                           Received patient back to the ward:<br/>
Patient is diagnosed to have DVT</td>
                <td  colspan="5" align="center" class="style15" >
...
- did not confirm the right patient with ID tag.</td>
            </tr>
           <%-- ------------------------------------------------------------------------------- --%>   
			    <tr>
                <td class="style15">
                            14</td>
                <td align="left" class="style15" rowspan="2">
...
4. IMR is signed/E-IMR is marked as done
                ...
                <td >
				    ...
				    <td align="left" class="font-italic" rowspan="2">
                           TSO:<br/>** Accord "0" mark if student:<br/>
...
- Initiate anti-coagulation therapy: Subcutaneous injection heparin 80 mg stat and daily in the morning<br/>
- Place patient on intermittent pneumatic calf compressor (IPC) <br/>
- Refer the patient to physiotherapy for passive exercise<br/>
- Blood investigations: Daily APTT, INR<br/>
- Measure size of both thighs and calfs now and every morning<br/>
- Elevate of legs above heart level when patient in bed
</td>
                <td  colspan="5" align="center" class="style15" >
		  ...
		  <%-- ------------------------------------------------------------------------------- --%> 	
                ...
                <td class="style15">
                            16</td>
                <td align="left" class="style15" rowspan="4">
                          Administer subcutaneous injection heparing 80mg stat and daily in the morning
                            </td>
				    <td align="left" class="style15">
...
-  did not observe for side effects of the medications.
                            </td>
            </tr>
	  <%-- ------------------------------------------------------------------------------- --%> 	
                ...
                <td  colspan="5" align="center" class="style17" >
             ...
             <%-- ------------------------------------------------------------------------------- --%> 
			  ...
			  <tr>
                <td class="style15">
                    20</td>
                <td align="left" class="style15" rowspan="2">
                  Place patient on intermittent pneumatic calf compressor (IPC) </td>
                <td align="left" class="style15">
                   Elevate of legs above heart level when patient in bed</td>
                <td  colspan="5" align="center" class="style15" >
                ...
                <td class="font-italic" rowspan="2">
                    ...
                    Lecturer:<br/> 
**Accord "0" mark if student:<br/> 
- did not elevate the leg at the heart level.<br/> 
- did not measure the both thighs and legs.</td>
            </tr>
			 ...
			 <tr>
                ...
                <td align="left" class="style15">
                   Measure size of both thighs and calfs now and every morning </td>
                <td  colspan="5" align="center" class="style15" >
             ...
             <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td class="style15">
                    22</td>
                <td align="left" class="style15">
                   Blood investigations: Daily APTT, INR ( coming morning) </td>
				   <td align="left">
				   Pass over to the coming morning shift staff </td>
                <td  colspan="5" align="center" class="style15" >
                ...
                <td class="style16">
                    ...
                    Lecturer: <br/>
** Accord "0" if student:<br/>
- did not pass over the blood investigation to coming morning shift staff.</td>
            </tr>
              <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td class="style15">
                    23</td>
                <td align="left" class="style15">
                 Refer the patient to physiotherapy for passive exercise </td>
					 <td align="left" >
                   Perform effective communication to physiotherapist</td>
                <td  colspan="5" align="center" class="style15" >
                ...
                <td class="style16">
                    ...
                    Lecturer: <br/>
** Accord "0" mark if student: <br/>
- Inefficient update regarding patient's condition. </td>
            </tr>
		    <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td class="style15">
                    24</td>
                <td align="left" class="style15" rowspan="3" >
                  Perform  physical assessment from head to toe, neurovascular assessment and CLC </td>
                <td align="left" class="style15">
...
- Motor response </td>
                ...
                <td class="font-italic">
                    ...
                    Lecturer: <br/>
** Accord "0" mark if student: <br/>
- did not perform GCS: eye opening, best verbal response and motor response.<br/>
<br/><br/>
...
- Able to lift up the upper limb but have difficulty in lifting the left leg and swelling seen on the left leg.
             ...
             <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td class="style15">
                    25</td>
                <td align="left" class="style15">
                 Perform neurovascular assessment:</td>
                <td  colspan="5" align="center" class="style15" >
		  ...
		  <tr>
                ...
                <td align="left" class="style15" rowspan="4">
                   Administer the following medications as ordered:  <br/>
					...
					- Senna 2 tablets PO as required (discontinue if loose stool) <br/>
					- IM morphine 5-10mg 4 hourly prn ( for severe pain)
					 </td>
					 <td align="left" >
		   ...
		   <%-- ------------------------------------------------------------------------------- --%>  
		       <tr>
                <td class="style15">
                    31</td>
                <td align="left" class="style15" rowspan="3">
                  IV Ampicillin 500mg in 100mLs 0.9% Normal saline every 4 hourly</td>
                <td align="left" class="style15">
...
4. IMR is signed/E-IMR is marked as done</td>
                ...
                <td class="font-italic">
                    ...
                    Lecturer:<br/> 
** Accord "0" mark if student:  <br/>
- did not proper documentation of procedure in the report. 
</td>
            </tr>
		   <%-- ------------------------------------------------------------------------------- --%> 
		      <tr>
...
- evaluate patient vital signs, pain status and patient education (if required).
</td>
            </tr>
...
Good evaluation of patient's condition</td>
                ...
                <td class="font-italic">
                    ...
                    Lecturer:<br/> Deduct marks to "1" or "2" marks for this category if students:<br/>
- did not inform the doctor immediately  if there is any abnormal findings detected.
</td>
            </tr>
          ...
          <tr>
                ...
                <td colspan="5" align="center">
                    &nbsp;</td>
                <td align="center">
                    <asp:Label ID="Label60" runat="server" Font-Names="Arial" Font-Bold="true" Text="148"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
                <td>
       ...
       CausesValidation="false" 
            ...
            <tr>
              ...
              <br/>  <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Bold="true" Text="Total/148 X 5% "></asp:Label>
                </td>
                <td colspan="8" align="left">
                    &nbsp;</td>
            </tr>
