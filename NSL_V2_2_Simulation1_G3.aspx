<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_2_Simulation1_G3.aspx.cs" Inherits="NSL_V2_2_Simulation1_G3" %>
 ...
 function  show_score()
{
 ...
 if (rb != null)
    ...
    actual_score_float = (parseInt(total_score) / 128) * (5 / 100) * 100;//Total/128 X 5% 
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="SIM1-OPTION 3"
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
 ...
 <%-- ------------------------------------------------------------------------------- --%> 
           <tr>
                ...
                <td class="font-italic" rowspan="4" valign="top">
                  
                    Patient is awake, alert and oriented to person, place and time when talking to 
                    students. General oedema on the face, abdomen, hands and legs seen</td>
            </tr>  
...
<%-- ------------------------------------------------------------------------------- --%> 
 ...
 <tr>
                <td>
                    7</td>
                <td align="left">
                   Obtain subjective data from patient/relatives to plan nursing interventions for the shift
</td>
                <td  colspan="5" align="center" >
...
<%-- ------------------------------------------------------------------------------- --%> 
   ...
   <tr>
                ...
                <td>
                    ...
                    TSO:<br/>
Activate state 1:  <br/>
RR-26b/min, HR-120b/min, BP-175/98 mmHg, SpO2-98%, Temp-36.5°C, Urine output-Nil
  ...
  <tr>
                ...
                <td align="left" class="style13">
                   Pain assessment: Use of OLDCART, pain score (uterine contraction or frontal headache)
</td>
 ...
 <tr>
                ...
                <td align="left" class="style7">
                   Perform physical assessment from head to toe
					 ...
					 <td align="left" class="style7">
                   Check pupils size, oedema, deep tendon reflexes, fetal heart rate 
</td>
                <td  colspan="5" align="center" class="style7" >
...
- did not check the pupils size (3mm and  reactive to lights), oedema (pitting oedema - 4+) and deep tendon reflexes (3+), capillary refills 3 seconds all extremities and fetal heart rate - 120b/min with late deceleration seen on CTG.
          ...
          <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td class="style7">
                    14</td>
                <td align="left" class="style7" rowspan="6">
                  Administer 50mLs MgSO4 to 250mLs to 5% Dextrose; increase to 2gm MgSo4 at 40mLs/hr 
                ...
                <td class="style7">
                    ...
                    <asp:TextBox ID="remarks14" runat="server" TextMode="MultiLine"    
                        class="RemarksTextarea" Font-Names="Arial" Text=""></asp:TextBox></td>
			...
			** Accord "0" mark if<br/>
			...
			- fail to identify side effects of MgSO4.<br/>
			- fail to identify signs of fluid overload.
 ...
 <tr>
  ...
  <tr>
                ...
                <td align="left" class="style9">
                         ** Ensure administer the correct amount of medications
</td>
  ...
  <tr>
                ...
                <td align="left" class="style9">
                 Monitor uterine contractions and fetal heart rate every 15 minutes
				</td>
                <td  colspan="5" align="center" class="style9" >
  ...
  <tr>
                ...
                <td align="left" class="style9">
                   CTG monitoring shows late deceleration
</td>
                <td  colspan="5" align="center" class="style9" >
...
- did not inform doctor on the late deceleration.
             ...
             <%-- ------------------------------------------------------------------------------- --%> 
              <tr>
                <td class="style9">
                    21</td>
                <td align="left" class="style9" >
                    Continuously monitor urine output closely<br/>
Insert indwelling urinary catheter with hourly urine output

</td>
                <td align="left" class="style9">
                  Monitor urine output (normal urine output is 30mLs/hour)   
 </td>
                <td  colspan="5" align="center" class="style9" >
...
- did not inform doctor when urine output is < 30mLs/hr.
</td>
            </tr>
           <%-- ------------------------------------------------------------------------------- --%> 
              <tr>
                <td class="style9">
                    22</td>
                <td align="left" class="style9" >
                   Call doctor to inform patient's urine output NiL, BP 175/98mmHg, patient complains of headache and nausea 
</td>
                <td align="left" class="style9">
                    To increase magnesium sulfate to 2g/hr<br/>
To give IV labetalol 20mg bolus stat
 </td>
                <td  colspan="5" align="center" class="style9" >
                ...
                <td class="style10"  valign="top">
                   ...
                   Inefficient situation update/background
</td>
            </tr>
              <%-- ------------------------------------------------------------------------------- --%> 
  ...
  <tr>
                <td class="style9">
                    23</td>
                <td align="left" class="style9" rowspan="3">
                   Administer  IV 5% Dextrose  at 100mLs/hr
  ...
  <tr>
                ...
                <td align="left" class="style9">
            Ensure administer the correct amount of IV fluids
...
** Document in CLC and PE chart
                ...
                <td class="font-italic">
                  TSO:<br/>
Activate state 2:  <br/>
RR-22b/min, HR-100b/min, BP-125/70 mmHg, SpO2-98%, Temp-36.5°C, Urine output-Nil
</td>
            </tr>
   ...
   <%-- ------------------------------------------------------------------------------- --%> 
     <tr>
                <td class="style7">
                    27</td>
                <td align="left" class="style7" >
                  Call doctor to inform late deceleration 
</td>
                <td align="left" class="style7">
...
Prepare patient for caesarean section
     ...
     <tr>
                ...
                <td align="left" class="style7">
                   Consent obtained from husband<br/>
Pre-operative preparation<br/>
- shaving of the abdomen<br/>
Send patient to OT
</td>
                <td  colspan="5" align="center" class="style7" >
...
- did not conduct the required assessment or management within the stipulated time.
               ...
               <%-- ------------------------------------------------------------------------------- --%> 
                ...
                <td class="style7">
                    32</td>
                <td align="left" class="style7" >
               Display critical thinking and holistic management of patient care
   ...
   <%-- ------------------------------------------------------------------------------- --%> 
       ...
       CausesValidation="false" 
            ...
            <tr>
              ...
              </br>  <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Bold="true" Text="Total/128 X 5% "></asp:Label>
                </td>
                <td colspan="8" align="left">
                    &nbsp;</td>
            </tr>
