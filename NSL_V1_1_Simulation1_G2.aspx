<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V1_1_Simulation1_G2.aspx.cs" Inherits="NSL_V1_1_Simulation1_G2" %>
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="Consolidation Skills 1 (GROUP 2)"
 ...
 <%-- ---------------------------------------------------------------------------------------------%>
              ...
              <tr>
                <td align="left" colspan="11" class="styleCC" style="text-align:justify">
                    Brief Summary:
                    <br />
                  Madam Anita Perez, 78 year-old nursing home resident was admitted to hospital with the diagnosis of pulmonary tuberculosis. <br/>
				  Doctor has ordered to place her under airborne precautions and she is nursed in a negative pressure room.  
				  This morning, she had a spike fever with temperature of 38.8 °C. 
 <br /> <br />Group task:
 <br />Nurse 1: Don and remove PPE. 
 <br />Nurse 2 & 3: Perform tepid sponging and change the linen while patient was in bed and dispose the linens accordingly.
 <br />Nurse 4 & 5: Turn the patient from supine to right lateral positioning.
	 </td>
            </tr>
             <tr bgcolor="#98272D" >
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
		  ...
		  <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					<td>11</td>
					<td align="left" rowspan="3">Perform tepid sponging appropriately 
					</td>
					<td align="left">Place wet washcloths on patient’s forehead, neck, axilla and groin.
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					...
					<td align="left">Change washcloths every 5 minutes. 
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					...
					<td align="left">Dab dry the body and put on clean clothes.
