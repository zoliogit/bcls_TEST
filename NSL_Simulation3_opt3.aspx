<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_Simulation3_opt3.aspx.cs" Inherits="NSL_Simulation3_opt3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Tracheostomy Care - Suctioning with PVC</title>
            ...
            <tr>
                <td bgcolor="#F7F6F3" class="styleCC">
                    ...
                    <asp:Label ID="Label161" runat="server" Font-Bold="False" Font-Size="X-Large" ForeColor="Black"
                        Text="Tracheostomy Care- SUCTIONING With PVC" Font-Names="Arial"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div>
        <table bgcolor="White" border="1" bordercolor="#98272d" style="border-collapse: collapse;
            width: 100%; height: 100%" align="center">
             ...
             <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="style9" bgcolor="#98272D" 
                       style="border: 1px solid white;">
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" Text= "OPTION 3 (SUCTIONING WITH PVC)"
            ...
            <%-- ---------------------------------------------------------------------------------------------%>
                ...
                <td align="center" colspan="11" bgcolor="#98272D">
                    <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Size="Large" Text="Trachy Suctioning With PVC"
                        Font-Names="Arial" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="left" style="text-align:justify" colspan="11" >
                  Scenario Summary: <br />
...
<br />Drug Allergy: NKDA
							

</td></tr><tr bgcolor="#98272D">
            ...
            <tr >
                <td align="left" colspan="10" >
                    <asp:Label ID="Label5" runat="server" Text="Current situation: At 2300 hours, your team has already took over the case from the evening duty. Demonstrate the plan of care after taking over the patient."
            ...
            <tr>
                ...
                <td class="font-italic">
                    Students to continue and review all documentation and charts from previous 
                    group.</td>
            </tr>
            <tr>
                <td align="left">
                    Review all orders from progress note </td>
                <td class="font-italic">
                    Lecturer: 
                    <br />
                    To insert the progress note with doctor&#39;s afternoon review and orders 
                    .</td>
            </tr>
            <tr>
                <td align="left">
            ...
            <tr>
                ...
                <td colspan="5" align="center" rowspan="2">
                    <asp:RadioButtonList ID="RadioButtonList4" RepeatColumns="5" class="style_radio" 
                        runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" Width="100%">
                        <asp:ListItem Text="" Value="0"></asp:ListItem>
                        <asp:ListItem Text="" Value="1"></asp:ListItem>
                        <asp:ListItem Text="" Value="2"></asp:ListItem>
            ...
            <tr>
                ...
                <td rowspan="2" class="font-italic">
                    TSO/Lecturer:<br/> To prepare the clean and dry trachy dressing.
            ...
            <tr>
                ...
                <td rowspan="4" class="font-italic">State 3: Respiratory distress with PVC
                    RR=28, HR=105, BP=100/70,SpO2=95%
                    ECG - multiple PVC<br />
                    TSO/Lecturer: <br />
                    To stimulate coughing<br />
            ...
            <tr>
                <td align="left">
                    ...
                    accurately follow doctor&#39;s order.</td>
            </tr>
             <%----------------------------------10----------------------------------------- --%>
            ...
            <tr>
                <td>
                    10</td>
                <td align="left">
                    **Interprete parameters and relate to client&#39;s condition (If tachycardia, 
                    tachypnea, drop SpO2 - signs of respiratory distress / low BP and PVC - low K 
                    due to diuresis).</td>
                <td colspan="5" align="center">
             ...
             <tr>
                ...
                <td class="font-italic">
                   TSO/Lecturer:<br /> To increase heart rate to 120bpm after initiation of Nebuliser.  (After 1-2mins, To inform student nebulisation is completed) Lecturer:
<br />**Accord "0" mark if student fail to perform any of the required steps before serving medication. 
...
Breath sounds - crackles
               ...
               <%--  --------------------------14--------------------------------------------%>
                ...
                <td rowspan="2">
                                        14</td>
                <td align="left" rowspan="3">
                    Management for multiple PVC</td>
                <td align="left">
                    Perform and review 12 leads ECG.</td>
                <td colspan="5" align="center" rowspan="2">
            ...
            <tr>
                ...
                <td align="left">
                    Check serum electrolytes (Esp Potassium).</td>
            ...
            <tr>
                <td>
                    15</td>
                <td align="left">
                    Administer IV premix KCL as prescribed correctly.</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    16</td>
                <td align="left" rowspan="3">
                    Confirm client&#39;s need for suctioning.</td>
                <td align="left">
                    Check suctioning chart for previous suction performed.</td>
                <td colspan="5" align="center">
                ...
                <td class="font-italic">
                    Last suctioning was done at 1900hr with minimal secretion (4hrs from current 
                    time).</td>
            </tr>
             <%--------------------------------17------------------------------------------- --%>
            ...
            <tr>
                <td>
                    17</td>
                <td align="left" >
                    Perform 4-point auscultation for presence of secretion.</td>
                <td colspan="5" align="center">
            ...
            <tr>
                ...
                <td align="left" class="style7">
                    Students observe for:
                    <br />
                    *Audible adventitious sounds
                    <br />
                    *Bubbles of mucus in tracheostomy opening.
                    <br />
                    *Increase respiratory rate, drop in SpO2, decrease LOC. </td>
                ...
                <td class="font-italic"> 
                    TSO/Lecturer:
                    <br />
                    To stimulate coughing Breath sounds - crackles</td>
            </tr>
            <%--  ----------------------------19------------------------------------------%>
            <tr>
                <td rowspan="3">
                    19</td>
                <td align="left" rowspan="3">
                    Management to improve oxygenation and prevent hypoxia.</td>
                <td align="left">
                    Prop the patient up to 30 degrees to ease difficulty in breathing.</td>
                <td colspan="5" align="center" rowspan="3">
            ...
            <tr>
                <td align="left">
                    Administer oxygen 5L/min via tracheostomy mask as ordered.</td>
            </tr>
            <tr>
                <td align="left">
            ...
            <%--  ----------------------------20------------------------------------------%>
                ...
                <td align="left">
                    Wear disposable latex gloves.</td>
                <td colspan="5" align="center" rowspan="2">
                ...
                <td rowspan="2" class="font-italic">
                    **Accord &quot;0&quot; mark if student did not change the inner tube to non-fenestrated 
                    prior suctioning.</td>
            </tr>
            
                   <tr>
                <td align="left">
                    Change the inner tube in correct manner by holding on the plate.</td>
            </tr>
            <%--  ------------------------------21----------------------------------------%>
            <tr>
                ...
                <td align="left" rowspan="7">
                    Prepare the requisites and environment well.</td>
                <td align="left">
                    **Determine the right suction catheter size.</td>
                <td colspan="5" align="center">
                ...
                <td rowspan="7" class="font-italic">
                    Note: **Accord &quot;0&quot; mark to the respective steps if the student failed to perform 
                    the following 5 situations:
                    <br />
                    1) suction machine is not on
                    <br />
                    2) suction pressure is not within normal range
                    <br />
                    3) the manual resuscitator is not connected to 15L oxygen.
                    <br />
                    4) the catheter size is wrong
                    <br />
                    5) incorrect inner tube </td>
            </tr>
             <%-------------------------------22-------------------------------------------- --%>
            ...
            <tr>
                <td rowspan="2">
                    22</td>
                <td align="left">
                    Gather the necessary requisites for suctioning (suction catheters, container 
                    with water for flushing, sterile disposable polythene gloves, clean latex 
                    gloves, apron and mask).</td>
                <td colspan="5" align="center" rowspan="2">
            ...
            <tr>
                <td>
                    25</td>
                <td align="left">
                    **Assemble suction equipment and apparatus. (Regular, 80-120mmHg)</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    26</td>
                <td align="left">
                   **Prepare manual resuscitator. (Adjust to 15L/min of O2 flow)
</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    27</td>
                <td align="left" rowspan="7">
                    Perform tracheostomy suctioning aseptically.</td>
                <td align="left">
                    Medical hand hygiene.</td>
                <td colspan="5" align="center">
                ...
                <td rowspan="7" class="font-italic">
                    Note: 
                    <br />
                    **Accord &quot;0&quot; mark if there is any contamination for the particular step/s.
                    <br />
                    **Accord &quot;0&quot; mark if patient was not hyperventilated prior and after suctioning</td>
            </tr>
             <%---------------------------------------28------------------------------------ --%>
            ...
            <tr>
                <td>
                    28</td>
                <td align="left">
                    **Don clean latex gloves and including a sterile glove on dominant hand without 
                    contamination.</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    29</td>
                <td align="left">
                    **Retract suction catheter from the package without contamination.</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    30</td>
                <td align="left">
                    Verify parameters: HR/RR/SpO2.</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    31</td>
                <td align="left">
                    **Hyperventilate patient till SpO2 &gt; 95%.</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    32</td>
                <td align="left">
                    **Insert catheter without contamination (7-10cm).</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    33</td>
                <td align="left">
                    Apply suction while withdrawing (&lt;15secs).</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td rowspan="2">
                                        34</td>
                <td align="left" rowspan="5">
                    Immediate care post every attempt of suctioning.</td>
                <td align="left">
                    Verify parameters: HR/RR/SpO2.</td>
                <td colspan="5" align="center" rowspan="2">
                ...
                <td rowspan="5" class="font-italic">
                    ...
                    <br />
                    Recovery state HR-90bpm, BP- 130/80mmhg, RR-25, SpO2 98%. 
                    This state is activated if students have performed the suctioning procedure 
                    satisfactory. 
                    <br />
                                        Note: 
                    <br />
                    **Accord &quot;0&quot; mark if bolded step/s is not done.<br />
                    </td>
            </tr>
            <tr>
                <td align="left">
            ...
            <tr>
                <td>
                    35</td>
                <td align="left">
                    Continue the trachy suctioning for another 2 times, change a new catheter if 
                    further suctioning needed.</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    36</td>
                <td align="left">
                    **Continue O2 delivery via trachy mask. </td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td>
                    37</td>
                <td align="left">
                    Perform oral and nasal suctioning.</td>
                <td colspan="5" align="center">
            ...
            <tr>
                <td rowspan="3">
                    38</td>
                <td align="left" rowspan="3">
                    Demonstrate proper clearing of disposables.</td>
                <td align="left">
                    Flush suction catheter and tubing with water.</td>
                <td colspan="5" align="center" rowspan="3">
            ...
            <tr>
                <td align="left">
                    Dispose suction catheter by coiling and degloving over.</td>
            </tr>
            <tr>
                <td align="left">
            ...
            <tr>
                <td rowspan="2">
                    39</td>
                <td align="left" rowspan="2">
                    Check for clearance of airway.</td>
                <td align="left">
                    Auscultate the breath sounds bilateral - apexes and bases of lungs.</td>
                <td colspan="5" align="center" rowspan="2">
       ...
       --%>
           <%--  ----------------------------41------------------------------------------%>
            ...
            <tr>
                <td align="left">
                    Shake dry before keeping in cover container.</td>
            </tr>
            <%--  --------------------------------42--------------------------------------%>
            <tr>
                <td rowspan="6">
                ...
                <td align="left" rowspan="6">
                    Document in suctioning chart.</td>
                <td align="left">
                    Date and time.</td>
            ...
            <tr>
                <td align="left" class="style10">
                    Unsual findings or interventions.</td>
            </tr>
            <tr>
                <td align="left">
            ...
            <tr>
                <td align="left" class="style10">
                    The color, amount, consistency of the mucus and presence of strong odour.</td>
            </tr>
           ...
           <%--------------------------------------------------------------------------- --%>
            ...
            <tr>
                ...
                <td colspan="5" align="center">
                    &nbsp;</td>
                <td align="center">
                    <asp:Label ID="Label47" runat="server" Font-Names="Arial" Font-Bold="true" Text="188"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
                <td>
