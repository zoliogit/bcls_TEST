<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="student_failed_report.aspx.cs" Inherits="student_failed_report" %>

<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    <title>failed_students-BCLS </title>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="X-Large" ForeColor="Black"
        Text="Follow up Students Details" Font-Names="Arial"></asp:Label>
</asp:Content>
