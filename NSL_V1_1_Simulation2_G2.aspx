<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V1_1_Simulation2_G2.aspx.cs" Inherits="NSL_V1_1_Simulation2_G2" %>
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
		  ...
		  <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				<tr>
					...
					<td align="left">Moist the swab with 2 drops of sterile normal saline and insert the swab stick into patient's nostril about 2.5cm or until resistance is felt at the root of the nose.</td>
					<td  colspan="5" align="center" >
