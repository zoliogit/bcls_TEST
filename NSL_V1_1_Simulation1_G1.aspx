<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V1_1_Simulation1_G1.aspx.cs" Inherits="NSL_V1_1_Simulation1_G1" %>
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="Consolidation Skills 1 (GROUP 1)"
 ...
 <%-- ---------------------------------------------------------------------------------------------%>
              ...
              <tr>
                <td align="left" colspan="11" class="styleCC" style="text-align:justify">
                    Brief Summary:
                    <br />
                   Madam Letchumi, 60-years-old, with chief complain of cough and fever for one week was admitted to hospital. She was diagnosed with chest infection and MRSA in sputum. She was placed in an isolation room.
 <br /> <br />Group tasks:
 <br />Nurse 1: Don and remove PPE.
 <br />Nurse 2: Serve a bedpan to patient in the bed. 
 <br />Nurse 3:  Change the linen in an occupied bed as the bedsheet is soiled.
 <br />Nurse 4 & 5: Turn the patient  from supine to left lateral position.								
...
or Student Intervention" Font-Bold="True" Font-Size="Large" Font-Names="Arial" ForeColor="White"></asp:Label>
		  ...
		  <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					<td>11</td>
					<td align="left" rowspan="3">Serve bed pan to patient in bed.
					</td>
					<td align="left">Assist patient to remove her pants and instruct patient to lift her hips and slip the bedpan under the patient. Ensure that the patient is at a comfortable position by elevating the head of the bed.
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					...
					<td align="left">Upon finishing, assist patient with cleaning or wiping (from front to back).
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					...
					<td align="left">While holding the bedpan with one hand, instruct the patient to lift up her hip and remove bedpan. Assist the patient to dress up.
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					<td>14</td>
					<td align="left" rowspan="3">Perform proper bed making in an occupied bed
					</td>
					<td align="left">Dirty Linen is removed with minimal contamination. 
					</td>
					<td  colspan="5" align="center" >
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Log roll patient from side to side safely when changing the bedsheet.
					</td>
					<td  colspan="5" align="center" >
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Linen is changed with minimal pain and discomfort to the patient 
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					<td>17</td>
					<td align="left" rowspan="6">Apply proper turning and positioning techniques
					</td>
					<td align="left">Move the patient to one of the bed by lifting the patient's body towards you in stages. 
					</td>
					<td  colspan="5" align="center" >
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Roll the patient to side-lying (left lateral) position. 
					</td>
					<td  colspan="5" align="center" >
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Ensure patient is comfortable by place the pillows to support patient's head and arms.
			 ...
			 <%---------------------------------------------------------------------------------------------------------------------------------------------%>
				...
				<tr>
					...
					<td align="left">Safe and proper body alignment and movements were achieved for patient.
					</td>
					<td  colspan="5" align="center" >
				...
				<tr>
					...
					<td align="left">Safe and proper body alignment and movements were achieved for nurses.
					</td>
					<td  colspan="5" align="center" >
