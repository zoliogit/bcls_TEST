<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NSL_V2_1_Simulation3_G1.aspx.cs" Inherits="NSL_V2_1_Simulation3_G1" %>
              ...
              <%-- ---------------------------------------------------------------------------------------------%>
               <tr>
                <td align="left" colspan="11" class="styleCC" bgcolor="#98272D">
                    <asp:Label ID="Label42" runat="server" Font-Bold="True" Font-Size="Large" Text="SIM3-OPTION 1"
            ...
            >
             ...
             <%-- ------------------------------------------------------------------------------- --%>                
                ...
                <td align="left" rowspan="6" >
                    **Obtain the patient&#39;s pre-transfusion vital signs.</td>
                <td align="left">
...
RR-26b/min, HR-120b/min, BP-108/58mmHg, SpO2-94%, Temp-36.9 deg Celcius&nbsp;</td>
            </tr>
           ...
           <%-- -----------------------------------------------------------------------
            ...
            <tr>
                ...
                <td class="font-italic">
                    ...
                    SpO2 is low as oxygen carrying capacity with blood loss.</td>
            </tr>                
            <%--   ------------------------------------------------------------------  --%>
                ...
                <td align="left" rowspan="4" >
                    Assess for the need for oxygen therapy</td>
                <td align="left">
                    Prop patient to 30 degree angle. </td>
                <td  colspan="5" align="center" >
                ...
                <td rowspan="4" class="font-italic">
                    Lecturer:</br> Check with student if humidication is necessary. Humidifier will be 
                    used if more than 4L is administered to prevent mucous membrance from drying 
        ...
        <tr>   
                <td>
                    6</td>
                <td align="left">
                    Select correct device for administration: Nasal cannula.</td>
                <td  colspan="5" align="center" >
                ...
                <td >
                    7</td>
                <td align="left" >
                    Adjust flow to the correct level. </td>
                <td  colspan="5" align="center"  >
           ...
           <%-- -----------------------------------------------------------------------
            --%>
                ...
                <td class="style7" >
                    8</td>
                <td align="left" >
                    Apply the cannula correctly unto the patient. </td>
             ...
             <tr>
                <td>
                    9</td>
                <td align="left" >
                    Check patient&#39;s blood investigations</td>
                <td align="left">
                    Able to check for Full Blood Count, Coagulation and Biochemistry blood results. 
                    Able to retrieve significant findings: 1) FBC: WBC 7.5, RBC: 3.9, Hb 7, Hct 21%, 
                    Platelets 200. 2) Biochemistry: Na 138, K 4, CI 112, CO2 23, Urea 6, Creatinine 
                    127, Glucose 7. 3) Coagulation PT 18, PTT 90</td>
                <td  colspan="5" align="center" >
                ...
                <td class="font-italic">
                    Refer case notes or EMR system for results: Allocate 1 mark for each type of 
                    blood result identified. </td>
            </tr>                
          <%--  ----------------------------------------------------------------------%>
             ...
             <tr>
                <td>
                    10</td>
                <td align="left" >
                    Observes the nature of vomittus, nasogastric drainage and stools</td>
                <td align="left">
                    Apply critical thinking and explain the abnormal findings.</td>
                <td  colspan="5" align="center" >
                ...
                <td class="font-italic">
                    Lecturer: Coffee grounds vomitus indicates upper GI bleed, dark tarry stools 
                    indicates digested blood</td>
            </tr>                
             ...
             <tr>
                <td>
                    11</td>
                <td align="left" >
                    Check correct placement of NG tube. </td>
                <td align="left">
                    Connects syringe and peforms aspiration as ordered.</td>
                <td  colspan="5" align="center" >
                ...
                <td class="font-italic">
                    Lecturer: Aspiration is minimal as patient is on continuous drainage.</td>
            </tr>                
             ...
             <tr>
                ...
                <td align="left" rowspan="5" >
                    Performs physical assessment : IAPP</td>
                <td align="left">
                    Apply critical thinking to explain why physical assessment should be done IAPP 
                    instead of IPPA. Perform physical assessment on the abdomen.</td>
                <td  colspan="5" align="center" >
                ...
                <td rowspan="5" class="font-italic">
                    Lecturer: Auscultation is done after inspection as percussion and palpation can 
                    increase peristalsis giving false interpretation of bowel sounds (Nursing Skills 
                    Book 2, 8th ed, 2015).</td>
            </tr>                
             ...
             <tr>
                <td>
                    13</td>
                <td align="left">
                    Inspection : contour, symmetry, detect 5F + A1: Fat, foetus, fluid, flatus, 
                    faeces, abdominal mass tumour. </td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                <td>
                    14</td>
                <td align="left">
                    Auscultation: listen for active bowel sounds in the four quadrants. </td>
                <td  colspan="5" align="center" >
             ...
             <tr>
                <td>
                    15</td>
                <td align="left">
                    Palpation: Perform light palpation in the four quadrants.</td>
                <td  colspan="5" align="center" >
        ...
        --%>   
             ...
             <tr>
                <td>
                    16</td>
                <td align="left">
                    Percussion: percuss lightly in the four quadrants, tympanic sound should be 
                    heard.</td>
                <td  colspan="5" align="center" >
         ...
         <%-- ------------------------------------------------------------------------------- --%>                
          ...
          <tr>
           ...
           <%--   ------------------------------------------------------------------  --%>
                ...
                <td>
                    21</td>
                <td align="left" rowspan="4" >
                    Check doctor&#39;s order in IMR for adminstration of IV Hartmans.</td>
                <td align="left">
                    Prime IV tubing with solution ordered in IMR.</td>
                <td  colspan="5" align="center" >
                ...
                <td class="font-italic" rowspan="4">
                    Student should be able to show the workings and count the drops and run the 
                    infusion.         </td>   </tr>                
                     <tr>
                <td>
                    22</td>
                ...
                <td>
                    23  </td>           <td align="left">
                    Swab IV port with alcohol swab before connecting and secure with micropore.</td>
                <td  colspan="5" align="center" >
          ...
          <%--  ----------------------------------------------------------------------%>
               ...
               <tr>
                <td>
                    25   </td>    <td align="left" >
                    Monitor the vital signs at regular intervals.</td>
                <td align="left">
                    Apply critical thinking and monitor the vital signs to detect for change in 
                    condition. Update the hourly parameters chart. </td>
                <td  colspan="5" align="center" >
                ...
                <td class="font-italic">
                    TSO: Patient c/o nausea and pain.  </td>  </tr>                
               ...
               <tr>
                ...
                <td class="font-italic">
                    ...
                    for administration by Staff Nurse.   </tr>                
         
               <tr>
                <td>
                    27</td>
                <td align="left" >
                    Prepare patient for endoscopy</td>
                <td align="left">
                    (Verbalise) Check consent has been taken for the procedure. Patient has been 
                    instructed to be on NBM.</td>
                <td  colspan="5" align="center" >
                    <b>
               ...
               <tr>
                <td class="style10">
                    30       <td align="left" class="style10" >
               ...
               <tr>
                <td class="style10">
                    31       <td align="left" class="style10" >
